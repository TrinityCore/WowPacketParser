...
{
    public unsafe struct DelIgnore
    {
        public QualifiedGUID Player;
        
        [Parser(Opcode.CMSG_DEL_IGNORE, ClientVersionBuild.Zero, ClientVersionBuild.V6_0_2_19033)]
        public static void HandleReadGuid(Packet packet)
        {
            packet.ReadGuid("GUID");
        }

        [Parser(Opcode.CMSG_DEL_IGNORE, ClientVersionBuild.V6_0_2_19033)]
