    ...
    public static class Builder
    {
        public static void DumpSQL(string prefix, string fileName, string header)
        {
            ...
            using (var store = new SQLFile(fileName))
            {
                ...
                Trace.WriteLine("02/22 - Write Spawns.GameObject"); if (gameObjects != null) store.WriteData(Spawns.GameObject(gameObjects));
                ...
                Trace.WriteLine("06/22 - Write UnitMisc.NpcTemplateNonWDB"); if (units != null) store.WriteData(UnitMisc.NpcTemplateNonWDB(units));
                Trace.WriteLine("07/22 - Write UnitMisc.Addon"); if (units != null) store.WriteData(UnitMisc.Addon(units));
                Trace.WriteLine("08/22 - Write UnitMisc.ModelData"); if (units != null) store.WriteData(UnitMisc.ModelData(units));
                ...
                Trace.WriteLine("11/22 - Write Spawns.Creature"); if (units != null) store.WriteData(Spawns.Creature(units));
                ...
                Trace.WriteLine("21/22 - Write UnitMisc.CreatureEquip"); if (units != null) store.WriteData(UnitMisc.CreatureEquip(units));
                Trace.WriteLine("22/22 - Write UnitMisc.CreatureMovement"); if (units != null) store.WriteData(UnitMisc.CreatureMovement(units));
