...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record ChrCustomizationReqLocaleHotfix340: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("chr_customization_req")]
    public sealed record ChrCustomizationReqHotfix344: IDataModel
    {
        [DBFieldName("RaceMask")]
        public long? RaceMask;
    ...
    [Hotfix]
    [DBTableName("chr_customization_req_locale")]
    public sealed record ChrCustomizationReqLocaleHotfix344: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
