...
namespace WowPacketParser.Store.Objects
{
    ...
    [Hotfix]
    [DBTableName("map")]
    public sealed record MapHotfix344: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
        ...
        [DBFieldName("Field115456400021")]
        public int? Field115456400021;
    ...
    [Hotfix]
    [DBTableName("map_locale")]
    public sealed record MapLocaleHotfix344: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
