...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record GarrFollowerHotfix1200 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record GarrFollowerLocaleHotfix1200 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_follower")]
    public sealed record GarrFollowerHotfix1210 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_follower_locale")]
    public sealed record GarrFollowerLocaleHotfix1210 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
