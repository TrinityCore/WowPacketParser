...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record ItemSearchNameHotfix1200: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record ItemSearchNameLocaleHotfix1200: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("item_search_name")]
    public sealed record ItemSearchNameHotfix1205: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("item_search_name_locale")]
    public sealed record ItemSearchNameLocaleHotfix1205: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
