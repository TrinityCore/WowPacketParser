...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record GarrMissionHotfix1200 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record GarrMissionLocaleHotfix1200 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_mission")]
    public sealed record GarrMissionHotfix1210 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_mission_locale")]
    public sealed record GarrMissionLocaleHotfix1210 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
