...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record SkillLineAbilityHotfix1200: IDataModel
    {
    ...
    public sealed record SkillLineAbilityLocaleHotfix1200: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("skill_line_ability")]
    public sealed record SkillLineAbilityHotfix1205: IDataModel
    {
        [DBFieldName("RaceMask")]
        public long? RaceMask;
    ...
    [Hotfix]
    [DBTableName("skill_line_ability_locale")]
    public sealed record SkillLineAbilityLocaleHotfix1205: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("skill_line_ability")]
    public sealed record SkillLineAbilityHotfix1207: IDataModel
    {
        [DBFieldName("AbilityVerb")]
        public string AbilityVerb;
    ...
    [Hotfix]
    [DBTableName("skill_line_ability_locale")]
    public sealed record SkillLineAbilityLocaleHotfix1207: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
