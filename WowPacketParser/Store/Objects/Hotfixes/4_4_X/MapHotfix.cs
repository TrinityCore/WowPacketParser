...
namespace WowPacketParser.Store.Objects
{
    [Hotfix]
    [DBTableName("map")]
    public sealed record MapHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record MapLocaleHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("map")]
    public sealed record MapHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("map_locale")]
    public sealed record MapLocaleHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
