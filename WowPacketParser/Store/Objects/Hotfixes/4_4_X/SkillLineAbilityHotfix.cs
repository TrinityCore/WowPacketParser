...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record SkillLineAbilityHotfix440: IDataModel
    {
    ...
    public sealed record SkillLineAbilityLocaleHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("skill_line_ability")]
    public sealed record SkillLineAbilityHotfix441: IDataModel
    {
        [DBFieldName("RaceMask")]
        public long? RaceMask;
    ...
    [Hotfix]
    [DBTableName("skill_line_ability_locale")]
    public sealed record SkillLineAbilityLocaleHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
