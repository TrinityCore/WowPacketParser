...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record BattlePetSpeciesHotfix440: IDataModel
    {
    ...
    public sealed record BattlePetSpeciesLocaleHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("battle_pet_species")]
    public sealed record BattlePetSpeciesHotfix441: IDataModel
    {
        [DBFieldName("Description")]
        public string Description;
    ...
    [Hotfix]
    [DBTableName("battle_pet_species_locale")]
    public sealed record BattlePetSpeciesLocaleHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
