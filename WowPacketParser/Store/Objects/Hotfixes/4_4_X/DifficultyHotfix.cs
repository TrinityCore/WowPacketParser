...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record DifficultyHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record DifficultyLocaleHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("difficulty")]
    public sealed record DifficultyHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("difficulty_locale")]
    public sealed record DifficultyLocaleHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
