...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record ItemSearchNameHotfix440: IDataModel
    {
    ...
    public sealed record ItemSearchNameLocaleHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("item_search_name")]
    public sealed record ItemSearchNameHotfix441: IDataModel
    {
        [DBFieldName("AllowableRace")]
        public long? AllowableRace;
    ...
    [Hotfix]
    [DBTableName("item_search_name_locale")]
    public sealed record ItemSearchNameLocaleHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
