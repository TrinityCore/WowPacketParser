...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record BroadcastTextHotfix440: IDataModel
    {
        [DBFieldName("Text")]
        public string Text;
    ...
    public sealed record BroadcastTextLocaleHotfix440: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("broadcast_text")]
    public sealed record BroadcastTextHotfix441: IDataModel
    {
        [DBFieldName("Text")]
        public string Text;
    ...
    [Hotfix]
    [DBTableName("broadcast_text_locale")]
    public sealed record BroadcastTextLocaleHotfix441: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
