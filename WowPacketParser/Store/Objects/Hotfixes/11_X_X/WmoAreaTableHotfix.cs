...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record WmoAreaTableHotfix1100: IDataModel
    {
    ...
    public sealed record WmoAreaTableLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("wmo_area_table")]
    public sealed record WmoAreaTableHotfix1117 : IDataModel
    {
        [DBFieldName("AreaName")]
        public string AreaName;
    ...
    [Hotfix]
    [DBTableName("wmo_area_table_locale")]
    public sealed record WmoAreaTableLocaleHotfix1117 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
