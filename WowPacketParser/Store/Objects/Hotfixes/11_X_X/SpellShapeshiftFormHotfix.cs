...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record SpellShapeshiftFormHotfix1100 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record SpellShapeshiftFormLocaleHotfix1100 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("spell_shapeshift_form")]
    public sealed record SpellShapeshiftFormHotfix1102 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("spell_shapeshift_form_locale")]
    public sealed record SpellShapeshiftFormLocaleHotfix1102 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("spell_shapeshift_form")]
    public sealed record SpellShapeshiftFormHotfix1110 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("spell_shapeshift_form_locale")]
    public sealed record SpellShapeshiftFormLocaleHotfix1110 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
