...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record ChrRacesHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record ChrRacesLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("chr_races")]
    public sealed record ChrRacesHotfix1110 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("chr_races_locale")]
    public sealed record ChrRacesLocaleHotfix1110 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
