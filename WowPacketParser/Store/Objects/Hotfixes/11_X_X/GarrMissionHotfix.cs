...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record GarrMissionHotfix1100 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record GarrMissionLocaleHotfix1100 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_mission")]
    public sealed record GarrMissionHotfix1102 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_mission_locale")]
    public sealed record GarrMissionLocaleHotfix1102 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
