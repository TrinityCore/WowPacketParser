...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record GarrFollowerHotfix1100 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record GarrFollowerLocaleHotfix1100 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_follower")]
    public sealed record GarrFollowerHotfix1110 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("garr_follower_locale")]
    public sealed record GarrFollowerLocaleHotfix1110 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
