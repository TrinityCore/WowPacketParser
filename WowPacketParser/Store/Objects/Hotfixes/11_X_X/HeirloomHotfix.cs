...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record HeirloomHotfix1100: IDataModel
    {
    ...
    public sealed record HeirloomLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("heirloom")]
    public sealed record HeirloomHotfix1115 : IDataModel
    {
        [DBFieldName("SourceText")]
        public string SourceText;
    ...
    [Hotfix]
    [DBTableName("heirloom_locale")]
    public sealed record HeirloomLocaleHotfix1115 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
