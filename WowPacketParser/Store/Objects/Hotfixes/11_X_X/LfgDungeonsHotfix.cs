...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record LfgDungeonsHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record LfgDungeonsLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("lfg_dungeons")]
    public sealed record LfgDungeonsHotfix1105 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("lfg_dungeons_locale")]
    public sealed record LfgDungeonsLocaleHotfix1105 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
