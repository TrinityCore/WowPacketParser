...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record BattlemasterListHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record BattlemasterListLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("battlemaster_list")]
    public sealed record BattlemasterListHotfix1117 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("battlemaster_list_locale")]
    public sealed record BattlemasterListLocaleHotfix1117 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
