...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record CreatureFamilyHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record CreatureFamilyLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("creature_family")]
    public sealed record CreatureFamilyHotfix1120 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("creature_family_locale")]
    public sealed record CreatureFamilyLocaleHotfix1120 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
