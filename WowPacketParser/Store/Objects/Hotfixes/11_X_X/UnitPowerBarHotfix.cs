...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record UnitPowerBarHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    public sealed record UnitPowerBarLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("unit_power_bar")]
    public sealed record UnitPowerBarHotfix1120 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("unit_power_bar_locale")]
    public sealed record UnitPowerBarLocaleHotfix1120 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
