...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record MapChallengeModeHotfix1100: IDataModel
    {
        [DBFieldName("Name")]
        public string Name;
    ...
    public sealed record MapChallengeModeLocaleHotfix1100: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("map_challenge_mode")]
    public sealed record MapChallengeModeHotfix1120 : IDataModel
    {
        [DBFieldName("Name")]
        public string Name;
    ...
    [Hotfix]
    [DBTableName("map_challenge_mode_locale")]
    public sealed record MapChallengeModeLocaleHotfix1120 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("map_challenge_mode")]
    public sealed record MapChallengeModeHotfix1127 : IDataModel
    {
        [DBFieldName("Name")]
        public string Name;
    ...
    [Hotfix]
    [DBTableName("map_challenge_mode_locale")]
    public sealed record MapChallengeModeLocaleHotfix1127 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
