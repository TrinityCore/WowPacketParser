...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record ChrCustomizationElementHotfix1000: IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("chr_customization_element")]
    public sealed record ChrCustomizationElementHotfix1017 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
    ...
    [Hotfix]
    [DBTableName("chr_customization_element")]
    public sealed record ChrCustomizationElementHotfix1020 : IDataModel
    {
        [DBFieldName("ID", true)]
        public uint? ID;
