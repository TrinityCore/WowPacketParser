...
namespace WowPacketParser.Store.Objects
{
    ...
    public sealed record CreatureEquipment : IDataModel
    {
        ...
        [DBFieldName("AppearanceModID1", TargetedDatabaseFlag.SinceLegion | TargetedDatabaseFlag.WotlkClassic | TargetedDatabaseFlag.CataClassic)]
        public ushort? AppearanceModID1;

        [DBFieldName("ItemVisual1", TargetedDatabaseFlag.SinceLegion | TargetedDatabaseFlag.WotlkClassic | TargetedDatabaseFlag.CataClassic)]
        public ushort? ItemVisual1;

        [DBFieldName("ItemID2")]
        public uint? ItemID2;

        [DBFieldName("AppearanceModID2", TargetedDatabaseFlag.SinceLegion | TargetedDatabaseFlag.WotlkClassic | TargetedDatabaseFlag.CataClassic)]
        public ushort? AppearanceModID2;

        [DBFieldName("ItemVisual2", TargetedDatabaseFlag.SinceLegion | TargetedDatabaseFlag.WotlkClassic | TargetedDatabaseFlag.CataClassic)]
        public ushort? ItemVisual2;

        [DBFieldName("ItemID3")]
        public uint? ItemID3;

        [DBFieldName("AppearanceModID3", TargetedDatabaseFlag.SinceLegion | TargetedDatabaseFlag.WotlkClassic | TargetedDatabaseFlag.CataClassic)]
        public ushort? AppearanceModID3;

        [DBFieldName("ItemVisual3", TargetedDatabaseFlag.SinceLegion | TargetedDatabaseFlag.WotlkClassic | TargetedDatabaseFlag.CataClassic)]
