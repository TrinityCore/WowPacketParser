...
namespace WowPacketParser.Misc
{
    public static class ClientVersion
    {
        ...
        private static readonly KeyValuePair<ClientVersionBuild, DateTime>[] _clientBuilds = new []
        {
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V5_4_0_17359,  new DateTime(2013, 09, 10)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V5_4_0_17371,  new DateTime(2013, 09, 13)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V5_4_0_17399,  new DateTime(2013, 09, 24)),
            ...
            get
            {
                switch (Build)
                {
                    ...
                    case ClientVersionBuild.V5_4_7_17956:
                        return ClientVersionBuild.V5_4_7_17930;
                    default:
                        return Build;
                }
            }
