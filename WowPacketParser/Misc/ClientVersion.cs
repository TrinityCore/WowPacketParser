...
namespace WowPacketParser.Misc
{
    public static class ClientVersion
    {
        ...
        private static readonly KeyValuePair<ClientVersionBuild, DateTime>[] ClientBuilds = {
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V11_2_5_64395, new DateTime(2025, 11, 15)),
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_1_66562, new DateTime(2026, 03, 24)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_1_66666, new DateTime(2026, 03, 26)),
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_5_67114, new DateTime(2026, 04, 24)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_5_67186, new DateTime(2026, 04, 24, 01, 30, 00)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_5_67235, new DateTime(2026, 04, 29)),
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_5_67823, new DateTime(2026, 05, 28)),

            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68182, new DateTime(2026, 06, 16)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68232, new DateTime(2026, 06, 16, 23, 55, 00)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68235, new DateTime(2026, 06, 17, 03, 39, 00)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68256, new DateTime(2026, 06, 18)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68275, new DateTime(2026, 06, 24)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68453, new DateTime(2026, 07, 07)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68887, new DateTime(2026, 07, 23)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_0_7_68974, new DateTime(2026, 08, 04)),

            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69273, new DateTime(2026, 08, 11)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69283, new DateTime(2026, 08, 13)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69299, new DateTime(2026, 08, 13, 18, 58, 00)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69323, new DateTime(2026, 08, 17)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69382, new DateTime(2026, 08, 18)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69404, new DateTime(2026, 08, 20)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69465, new DateTime(2026, 08, 24)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69497, new DateTime(2026, 08, 25)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69587, new DateTime(2026, 09, 02)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V12_1_0_69814, new DateTime(2026, 09, 12)),
        ...
        public static ClientVersionBuild GetVersionDefiningBuild(ClientVersionBuild build)
        {
            switch (build)
            {
                ...
                case ClientVersionBuild.V12_0_1_66562:
                ...
                case ClientVersionBuild.V12_0_5_67823:
                ...
                case ClientVersionBuild.V12_0_7_68275:
                ...
                case ClientVersionBuild.V1_15_8_67156:
                ...
                case ClientVersionBuild.V2_5_5_67511:
