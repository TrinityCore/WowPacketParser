...
namespace WowPacketParser.Misc
{
    public static class ClientVersion
    {
        ...
        private static readonly KeyValuePair<ClientVersionBuild, DateTime>[] _clientBuilds = new []
        {
            ...
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V4_3_2_15211, new DateTime(2012, 01, 31)),
            new KeyValuePair<ClientVersionBuild, DateTime>(ClientVersionBuild.V4_3_3_15354, new DateTime(2012, 02, 28))
        };
