...
namespace WowPacketParser.Enums.Version.V4_3_4_15595
{
    public static class Opcodes_4_3_4
    {
        ...
        private static readonly BiDictionary<Opcode, int> Opcs = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.SMSG_LF_GUILD_POST_REQUEST, 0x3237},
            ...
            {Opcode.SMSG_SPLINE_MOVE_UNSET_HOVER, 0x51B3},
            {Opcode.SMSG_SPLINE_MOVE_UNSET_HOVER, 0x7DA5},
            {Opcode.SMSG_SPLINE_MOVE_WATER_WALK, 0x50A2},
            {Opcode.SMSG_SPLINE_SET_FLIGHT_BACK_SPEED, 0x38B3},
            {Opcode.SMSG_SPLINE_SET_FLIGHT_SPEED, 0x39A0},
            {Opcode.SMSG_SPLINE_SET_PITCH_RATE, 0x14B0},
            {Opcode.SMSG_SPLINE_SET_RUN_BACK_SPEED, 0x3DB3},
            {Opcode.SMSG_SPLINE_SET_RUN_SPEED, 0x51B7},
            {Opcode.SMSG_SPLINE_SET_SWIM_BACK_SPEED, 0x59A1},
            {Opcode.SMSG_SPLINE_SET_SWIM_SPEED, 0x39A4},
            {Opcode.SMSG_SPLINE_SET_TURN_RATE, 0x78B5},
            {Opcode.SMSG_SPLINE_SET_WALK_BACK_SPEED, 0x34A5},
