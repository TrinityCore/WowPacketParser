namespace WowPacketParser.Enums.Version.V2_4_3_8606
{
    ...
    public enum UnitField
    {
        ...
        UNIT_FIELD_RESISTANCES_ARMOR = ObjectField.OBJECT_END + 0x00B4,
        UNIT_FIELD_RESISTANCES_HOLY = ObjectField.OBJECT_END + 0x00B5,
        UNIT_FIELD_RESISTANCES_FIRE = ObjectField.OBJECT_END + 0x00B6,
        UNIT_FIELD_RESISTANCES_NATURE = ObjectField.OBJECT_END + 0x00B7,
        UNIT_FIELD_RESISTANCES_FROST = ObjectField.OBJECT_END + 0x00B8,
        UNIT_FIELD_RESISTANCES_SHADOW = ObjectField.OBJECT_END + 0x00B9,
        UNIT_FIELD_RESISTANCES_ARCANE = ObjectField.OBJECT_END + 0x00BA,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_ARMOR = ObjectField.OBJECT_END + 0x00BB,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_HOLY = ObjectField.OBJECT_END + 0x00BC,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_FIRE = ObjectField.OBJECT_END + 0x00BD,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_NATURE = ObjectField.OBJECT_END + 0x00BE,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_FROST = ObjectField.OBJECT_END + 0x00BF,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_SHADOW = ObjectField.OBJECT_END + 0x00C0,
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_ARCANE = ObjectField.OBJECT_END + 0x00C1,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_ARMOR = ObjectField.OBJECT_END + 0x00C2,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_HOLY = ObjectField.OBJECT_END + 0x00C3,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_FIRE = ObjectField.OBJECT_END + 0x00C4,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_NATURE = ObjectField.OBJECT_END + 0x00C5,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_FROST = ObjectField.OBJECT_END + 0x00C6,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_SHADOW = ObjectField.OBJECT_END + 0x00C7,
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_ARCANE = ObjectField.OBJECT_END + 0x00C8,
