...
{
    public static class Opcodes_2_4_3
    {
        ...
        private static readonly BiDictionary<Opcode, int> ClientOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.CMSG_GM_WHISPER, 0x3B1},
            {Opcode.CMSG_COMMENTATOR_ENABLE, 0x3B4},
            {Opcode.CMSG_COMMENTATOR_GET_MAP_INFO, 0x3B6},
            {Opcode.CMSG_COMMENTATOR_GET_PLAYER_INFO, 0x3B8},
            {Opcode.CMSG_COMMENTATOR_ENTER_INSTANCE, 0x3BB},
            {Opcode.CMSG_COMMENTATOR_EXIT_INSTANCE, 0x3BC},
            {Opcode.CMSG_COMMENTATOR_INSTANCE_COMMAND, 0x3BD},
            {Opcode.CMSG_BOT_DETECTED, 0x3BF},
            {Opcode.CMSG_CHEAT_PLAYER_LOGIN, 0x3C1},
            {Opcode.CMSG_CHEAT_PLAYER_LOOKUP, 0x3C2},
            {Opcode.CMSG_COMPLAINT, 0x3C6},
            {Opcode.CMSG_GM_SHOW_COMPLAINTS, 0x3C9},
            {Opcode.CMSG_GM_UNSQUELCH, 0x3CA},
            {Opcode.CMSG_CHAT_CHANNEL_SILENCE_VOICE, 0x3CB},
            {Opcode.CMSG_CHAT_CHANNEL_SILENCE_ALL, 0x3CC},
            {Opcode.CMSG_CHAT_CHANNEL_UNSILENCE_VOICE, 0x3CD},
            {Opcode.CMSG_CHAT_CHANNEL_UNSILENCE_ALL, 0x3CE},
            {Opcode.CMSG_TARGET_CAST, 0x3CF},
            {Opcode.CMSG_TARGET_SCRIPT_CAST, 0x3D0},
            {Opcode.CMSG_CHAT_CHANNEL_DISPLAY_LIST, 0x3D1},
            {Opcode.CMSG_SET_ACTIVE_VOICE_CHANNEL, 0x3D2},
            {Opcode.CMSG_GET_CHANNEL_MEMBER_COUNT, 0x3D3},
            {Opcode.CMSG_CHAT_CHANNEL_VOICE_ON, 0x3D5},
            {Opcode.CMSG_CHAT_CHANNEL_VOICE_OFF, 0x3D6},
            {Opcode.CMSG_DEBUG_LIST_TARGETS, 0x3D7},
            {Opcode.CMSG_VOICE_ADD_IGNORE, 0x3DA},
            {Opcode.CMSG_VOICE_DEL_IGNORE, 0x3DB},
            {Opcode.CMSG_PARTY_SILENCE, 0x3DC},
            {Opcode.CMSG_PARTY_UNSILENCE, 0x3DD},
            {Opcode.CMSG_REPORT_PVP_PLAYER_AFK, 0x3E3},
            {Opcode.CMSG_GUILD_BANK_ACTIVATE, 0x3E5},
            {Opcode.CMSG_GUILD_BANK_QUERY_TAB, 0x3E6},
            {Opcode.CMSG_GUILD_BANK_SWAP_ITEMS, 0x3E8},
            {Opcode.CMSG_GUILD_BANK_BUY_TAB, 0x3E9},
            {Opcode.CMSG_GUILD_BANK_UPDATE_TAB, 0x3EA},
            {Opcode.CMSG_GUILD_BANK_DEPOSIT_MONEY, 0x3EB},
            {Opcode.CMSG_GUILD_BANK_WITHDRAW_MONEY, 0x3EC},
            {Opcode.CMSG_SET_CHANNEL_WATCH, 0x3EE},
            {Opcode.CMSG_CLEAR_CHANNEL_WATCH, 0x3F2},
            {Opcode.CMSG_SET_TITLE_SUFFIX, 0x3F6},
            {Opcode.CMSG_SPELL_CLICK, 0x3F7},
            {Opcode.CMSG_GM_CHARACTER_RESTORE, 0x3F9},
            {Opcode.CMSG_GM_CHARACTER_SAVE, 0x3FA},
            {Opcode.CMSG_MAELSTROM_RENAME_GUILD, 0x3FF},
            {Opcode.CMSG_GET_MIRROR_IMAGE_DATA, 0x400},
            {Opcode.CMSG_IGNORE_DIMINISHING_RETURNS_CHEAT, 0x404},
            {Opcode.CMSG_KEEP_ALIVE, 0x406},
            {Opcode.CMSG_OPT_OUT_OF_LOOT, 0x408},
            {Opcode.CMSG_GUILD_BANK_SET_TAB_TEXT, 0x40A},
            {Opcode.CMSG_SET_GRANTABLE_LEVELS, 0x40B},
            {Opcode.CMSG_GRANT_LEVEL, 0x40C},
            {Opcode.CMSG_REFER_A_FRIEND, 0x40D},
            {Opcode.CMSG_CHAT_CHANNEL_DECLINE_INVITE, 0x40F},
            {Opcode.CMSG_TOTEM_DESTROYED, 0x413},
            {Opcode.CMSG_EXPIRE_RAID_INSTANCE, 0x414},
            {Opcode.CMSG_NO_SPELL_VARIANCE, 0x415},
            {Opcode.CMSG_QUEST_GIVER_STATUS_MULTIPLE_QUERY, 0x416},
            {Opcode.CMSG_SET_PLAYER_DECLINED_NAMES, 0x418},
            {Opcode.CMSG_QUERY_SERVER_BUCK_DATA, 0x41A},
            {Opcode.CMSG_CLEAR_SERVER_BUCK_DATA, 0x41B},
            {Opcode.CMSG_ACCEPT_LEVEL_GRANT, 0x41F},
        };
        ...
        private static readonly BiDictionary<Opcode, int> ServerOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.SMSG_UPDATE_AURA_DURATION, 0x137},
            ...
            {Opcode.SMSG_VOICE_PARENTAL_CONTROLS, 0x3B0},
            {Opcode.SMSG_GM_MESSAGECHAT, 0x3B2},
            {Opcode.SMSG_COMMENTATOR_STATE_CHANGED, 0x3B5},
            {Opcode.SMSG_COMMENTATOR_MAP_INFO, 0x3B7},
            {Opcode.SMSG_COMMENTATOR_GET_PLAYER_INFO, 0x3B9},
            {Opcode.SMSG_COMMENTATOR_PLAYER_INFO, 0x3BA},
            {Opcode.SMSG_CLEAR_TARGET, 0x3BE},
            {Opcode.SMSG_CROSSED_INEBRIATION_THRESHOLD, 0x3C0},
            {Opcode.SMSG_CHEAT_PLAYER_LOOKUP, 0x3C3},
            {Opcode.SMSG_KICK_REASON, 0x3C4},
            {Opcode.SMSG_COMPLAINT_RESULT, 0x3C7},
            {Opcode.SMSG_FEATURE_SYSTEM_STATUS, 0x3C8},
            {Opcode.SMSG_CHANNEL_MEMBER_COUNT, 0x3D4},
            {Opcode.SMSG_DEBUG_LIST_TARGETS, 0x3D8},
            {Opcode.SMSG_AVAILABLE_VOICE_CHANNEL, 0x3D9},
            {Opcode.SMSG_COMSAT_RECONNECT_TRY, 0x3DF},
            {Opcode.SMSG_COMSAT_DISCONNECT, 0x3E0},
            {Opcode.SMSG_COMSAT_CONNECT_FAIL, 0x3E1},
            {Opcode.SMSG_VOICE_CHAT_STATUS, 0x3E2},
            {Opcode.SMSG_REPORT_PVP_AFK_RESULT, 0x3E4},
            {Opcode.SMSG_GUILD_BANK_QUERY_RESULTS, 0x3E7},
            {Opcode.SMSG_USERLIST_ADD, 0x3EF},
            {Opcode.SMSG_USERLIST_REMOVE, 0x3F0},
            {Opcode.SMSG_USERLIST_UPDATE, 0x3F1},
            {Opcode.SMSG_INSPECT_TALENT, 0x3F3},
            {Opcode.SMSG_GOGOGO_OBSOLETE, 0x3F4},
            {Opcode.SMSG_ECHO_PARTY_SQUELCH, 0x3F5},
            {Opcode.SMSG_LOOT_LIST, 0x3F8},
            {Opcode.SMSG_VOICESESSION_FULL, 0x3FB},
            {Opcode.SMSG_MIRROR_IMAGE_COMPONENTED_DATA, 0x401},
            {Opcode.SMSG_FORCE_DISPLAY_UPDATE, 0x402},
            {Opcode.SMSG_SPELL_CHANCE_RESIST_PUSHBACK, 0x403},
            {Opcode.SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT, 0x405},
            {Opcode.SMSG_READY_CHECK_ERROR, 0x407},
            {Opcode.SMSG_GROUP_ACTION_THROTTLED, 0x410},
            {Opcode.SMSG_OVERRIDE_LIGHT, 0x411},
            {Opcode.SMSG_TOTEM_CREATED, 0x412},
            {Opcode.SMSG_QUEST_GIVER_STATUS_MULTIPLE, 0x417},
            {Opcode.SMSG_SET_PLAYER_DECLINED_NAMES_RESULT, 0x419},
            {Opcode.SMSG_SERVER_BUCK_DATA, 0x41C},
            {Opcode.SMSG_SEND_UNLEARN_SPELLS, 0x41D},
            {Opcode.SMSG_PROPOSE_LEVEL_GRANT, 0x41E},
            {Opcode.SMSG_REFER_A_FRIEND_FAILURE, 0x420},
            {Opcode.SMSG_MOVE_SPLINE_SET_FLYING, 0x421},
            {Opcode.SMSG_MOVE_SPLINE_UNSET_FLYING, 0x422},
            {Opcode.SMSG_SUMMON_CANCEL, 0x423}
        };
        ...
        private static readonly BiDictionary<Opcode, int> MiscOpcodes = new BiDictionary<Opcode, int>
        {
            ...
            {Opcode.MSG_GM_GEARRATING, 0x3B2},
            {Opcode.MSG_RAID_READY_CHECK_FINISHED, 0x3C5},
            {Opcode.MSG_NOTIFY_PARTY_SQUELCH, 0x3DE},
            {Opcode.MSG_GUILD_BANK_LOG_QUERY, 0x3EE},
            {Opcode.MSG_GUILD_PERMISSIONS, 0x3FC},
            {Opcode.MSG_GUILD_BANK_MONEY_WITHDRAWN, 0x3FD},
            {Opcode.MSG_GUILD_EVENT_LOG_QUERY, 0x3FE},
            {Opcode.MSG_QUERY_GUILD_BANK_TEXT, 0x409},
            {Opcode.MSG_GM_CHANGE_ARENA_RATING, 0x40E}
        };
    }
}
