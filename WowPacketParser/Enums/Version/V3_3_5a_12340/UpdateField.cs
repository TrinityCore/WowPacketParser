namespace WowPacketParser.Enums.Version.V3_3_5a_12340
{
    ...
    public enum UnitField
    {
        ...
        UNIT_FIELD_RESISTANCES_ARMOR = ObjectField.OBJECT_END + 0x005D, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCES_HOLY = ObjectField.OBJECT_END + 0x005E, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCES_FIRE = ObjectField.OBJECT_END + 0x005F, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCES_NATURE = ObjectField.OBJECT_END + 0x0060, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCES_FROST = ObjectField.OBJECT_END + 0x0061, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCES_SHADOW = ObjectField.OBJECT_END + 0x0062, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCES_ARCANE = ObjectField.OBJECT_END + 0x0063, // Size: 1, Type: INT, Flags: PRIVATE, OWNER, ITEM_OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_ARMOR = ObjectField.OBJECT_END + 0x0064, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_HOLY = ObjectField.OBJECT_END + 0x0065, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_FIRE = ObjectField.OBJECT_END + 0x0066, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_NATURE = ObjectField.OBJECT_END + 0x0067, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_FROST = ObjectField.OBJECT_END + 0x0068, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_SHADOW = ObjectField.OBJECT_END + 0x0069, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSPOSITIVE_ARCANE = ObjectField.OBJECT_END + 0x006A, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_ARMOR = ObjectField.OBJECT_END + 0x006B, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_HOLY = ObjectField.OBJECT_END + 0x006C, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_FIRE = ObjectField.OBJECT_END + 0x006D, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_NATURE = ObjectField.OBJECT_END + 0x006E, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_FROST = ObjectField.OBJECT_END + 0x006F, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_SHADOW = ObjectField.OBJECT_END + 0x0070, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
        UNIT_FIELD_RESISTANCEBUFFMODSNEGATIVE_ARCANE = ObjectField.OBJECT_END + 0x0071, // Size: 1, Type: INT, Flags: PRIVATE, OWNER
