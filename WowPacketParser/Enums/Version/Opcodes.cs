...
using WowPacketParser.Enums.Version.V3_4_5_61815;
...
using WowPacketParser.Enums.Version.V5_5_4_68042;
    ...
    public static class Opcodes
    {
        ...
        public static BiDictionary<Opcode, int> GetOpcodeDictionary(ClientVersionBuild build, Direction direction)
        {
            switch (GetOpcodeDefiningBuild(build))
            {
                ...
                case ClientVersionBuild.V3_4_5_61815:
                    return Opcodes_3_4_5.Opcodes(direction);
                case ClientVersionBuild.V4_4_0_54481:
                ...
                case ClientVersionBuild.V5_5_4_68042:
                    return Opcodes_5_5_4.Opcodes(direction);
                default:
                    return Opcodes_3_3_5.Opcodes(direction);
            }
        }
