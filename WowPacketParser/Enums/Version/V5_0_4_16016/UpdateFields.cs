namespace WowPacketParser.Enums.Version.V5_0_4_16016
{
    ...
    public enum UnitField
    {
        ...
        UNIT_FIELD_SUMMONED_BY_HOMEREALM                    = ObjectField.OBJECT_END + 0x0010,
        ...
        UNIT_VIRTUAL_ITEM_SLOT_ID1                          = ObjectField.OBJECT_END + 0x002C,
        UNIT_VIRTUAL_ITEM_SLOT_ID2                          = ObjectField.OBJECT_END + 0x002D,
        UNIT_VIRTUAL_ITEM_SLOT_ID3                          = ObjectField.OBJECT_END + 0x002E,
        ...
        UNIT_FIELD_ATTACK_ROUND_BASE_TIME                   = ObjectField.OBJECT_END + 0x0032,
        UNIT_FIELD_RANGED_ATTACK_ROUND_BASE_TIME            = ObjectField.OBJECT_END + 0x0034,
        ...
        UNIT_FIELD_NATIVE_DISPLAYID                         = ObjectField.OBJECT_END + 0x0038,
        UNIT_FIELD_MOUNT_DISPLAYID                          = ObjectField.OBJECT_END + 0x0039,
        ...
        UNIT_FIELD_DYNAMIC_FLAGS                            = ObjectField.OBJECT_END + 0x0043,
        ...
        UNIT_FIELD_CREATED_BY_SPELL                         = ObjectField.OBJECT_END + 0x0048,
        UNIT_FIELD_NPC_FLAGS                                = ObjectField.OBJECT_END + 0x0049,
        UNIT_FIELD_EMOTESTATE                               = ObjectField.OBJECT_END + 0x004B,
        ...
        UNIT_FIELD_BATTLEPET_COMPANION_ID                   = ObjectField.OBJECT_END + 0x0090,
        UNIT_FIELD_BATTLEPET_COMPANION_NAME_TIMESTAMP       = ObjectField.OBJECT_END + 0x0091,
        UNIT_FIELD_END                                      = ObjectField.OBJECT_END + 0x0092
    };
