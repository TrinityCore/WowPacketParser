namespace WowPacketParser.Enums.Version.V2_5_2_39570
{
    ...
    public enum ActivePlayerField
    {
        ...
        ACTIVE_PLAYER_FIELD_BYTES_2                                       = PlayerField.PLAYER_END + 0x07E7,      // Size: 1, Flags: (PUBLIC) Nested: (TodayHonorableKills, YesterdayHonorableKills)
        ACTIVE_PLAYER_FIELD_BYTES_3                                       = PlayerField.PLAYER_END + 0x07E8,      // Size: 1, Flags: (PUBLIC) Nested: (LastWeekHonorableKills, ThisWeekHonorableKills)
        ACTIVE_PLAYER_FIELD_THIS_WEEK_CONTRIBUTION                        = PlayerField.PLAYER_END + 0x07E9,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_LIFETIME_HONORABLE_KILLS                      = PlayerField.PLAYER_END + 0x07EA,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_YESTERDAY_CONTRIBUTION                        = PlayerField.PLAYER_END + 0x07EB,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_LAST_WEEK_CONTRIBUTION                        = PlayerField.PLAYER_END + 0x07EC,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_LAST_WEEK_RANK                                = PlayerField.PLAYER_END + 0x07ED,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_WATCHED_FACTION_INDEX                         = PlayerField.PLAYER_END + 0x07EE,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_COMBAT_RATINGS                                = PlayerField.PLAYER_END + 0x07EF,      // Size: 32, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_PVP_INFO                                      = PlayerField.PLAYER_END + 0x080F,      // Size: 72, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_MAX_LEVEL                                     = PlayerField.PLAYER_END + 0x0857,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_SCALING_PLAYER_LEVEL_DELTA                    = PlayerField.PLAYER_END + 0x0858,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_MAX_CREATURE_SCALING_LEVEL                    = PlayerField.PLAYER_END + 0x0859,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_NO_REAGENT_COST_MASK                          = PlayerField.PLAYER_END + 0x085A,      // Size: 4, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_PET_SPELL_POWER                               = PlayerField.PLAYER_END + 0x085E,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_PROFESSION_SKILL_LINE                         = PlayerField.PLAYER_END + 0x085F,      // Size: 2, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_UI_HIT_MODIFIER                               = PlayerField.PLAYER_END + 0x0861,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_UI_SPELL_HIT_MODIFIER                         = PlayerField.PLAYER_END + 0x0862,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_HOME_REALM_TIME_OFFSET                        = PlayerField.PLAYER_END + 0x0863,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_MOD_PET_HASTE                                 = PlayerField.PLAYER_END + 0x0864,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_BYTES_4                                       = PlayerField.PLAYER_END + 0x0865,      // Size: 1, Flags: (PUBLIC) Nested: (LocalRegenFlags, AuraVision, NumBackpackSlots)
        ACTIVE_PLAYER_FIELD_OVERRIDE_SPELLS_ID                            = PlayerField.PLAYER_END + 0x0866,      // Size: 1, Flags: (PUBLIC, URGENT_SELF_ONLY)
        ACTIVE_PLAYER_FIELD_LFG_BONUS_FACTION_ID                          = PlayerField.PLAYER_END + 0x0867,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_LOOT_SPEC_ID                                  = PlayerField.PLAYER_END + 0x0868,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_OVERRIDE_ZONE_PVP_TYPE                        = PlayerField.PLAYER_END + 0x0869,      // Size: 1, Flags: (PUBLIC, URGENT_SELF_ONLY)
        ACTIVE_PLAYER_FIELD_BAG_SLOT_FLAGS                                = PlayerField.PLAYER_END + 0x086A,      // Size: 4, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_BANK_BAG_SLOT_FLAGS                           = PlayerField.PLAYER_END + 0x086E,      // Size: 7, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_QUEST_COMPLETED                               = PlayerField.PLAYER_END + 0x0875,      // Size: 1750, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_HONOR                                         = PlayerField.PLAYER_END + 0x0F4B,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_HONOR_NEXT_LEVEL                              = PlayerField.PLAYER_END + 0x0F4C,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_PVP_TIER_MAX_FROM_WINS                        = PlayerField.PLAYER_END + 0x0F4D,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_PVP_LAST_WEEKS_TIER_MAX_FROM_WINS             = PlayerField.PLAYER_END + 0x0F4E,      // Size: 1, Flags: (PUBLIC)
        ACTIVE_PLAYER_FIELD_BYTES_5                                       = PlayerField.PLAYER_END + 0x0F4F,      // Size: 1, Flags: (PUBLIC) Nested: (InsertItemsLeftToRight, PvpRankProgress)
