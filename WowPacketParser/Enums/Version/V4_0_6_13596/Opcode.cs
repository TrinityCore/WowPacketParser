namespace WowPacketParser.Enums.Version.V4_0_6_13596
{
    public enum Opcode
    {
        ...
        CMSG_COMMENTATOR_START_WARGAME                       = 0x08588, // 4.0.6a 13623 (might be CMSG_ITEM_QUERY_SINGLE)
        CMSG_ITEM_QUERY_MULTIPLE                             = 0x10008, // Unknown opcode ID
        SMSG_DB_REPLY                                        = 0x00C4E, // 4.0.6a 13623 (was SMSG_ITEM_QUERY_SINGLE_RESPONSE)
        ...
        SMSG_GUILD_INVITE                                    = 0x0010C, // 4.0.6a 13623 (might be 0x0B78C)
        CMSG_GUILD_ACCEPT                                    = 0x03729, // 4.0.6a 13623
        CMSG_GUILD_DECLINE                                   = 0x0352D, // 4.0.6a 13623
        SMSG_GUILD_DECLINE                                   = 0x0B78C, // 4.0.6a 13623 (might be 0x07DEC)
        CMSG_GUILD_INFO                                      = 0x06884, // 4.0.6a 13623
        SMSG_GUILD_INFO                                      = 0x020A8, // 4.0.6a 13623
        CMSG_GUILD_ROSTER                                    = 0x0250D, // 4.0.6a 13623 (might be 0x0B2A4)
        SMSG_GUILD_ROSTER                                    = 0x04D5C, // 4.0.6a 13623 (might be 0x038B0)
        CMSG_GUILD_PROMOTE                                   = 0x02109, // 4.0.6a 13623
        CMSG_GUILD_DEMOTE                                    = 0x0330D, // 4.0.6a 13623 (might be 0x01902)
        ...
        SMSG_GAMEOBJECT_CUSTOM_ANIM                          = 0x036A0, // 4.0.6a 13623 (might be 0x02E8C)
        ...
        MSG_MOVE_TOGGLE_COLLISION_CHEAT                      = 0x000D9, // Unknown opcode ID (might be 0x00028)
        ...
        SMSG_FORCE_RUN_BACK_SPEED_CHANGE                     = 0x1002E, // Unknown opcode ID
        ...
        CMSG_EMOTE                                           = 0x0FAC4, // 4.0.6a 13623 (might be 0x07F5C)
        ...
        CMSG_INSTANCE_LOCK_WARNING_RESPONSE                  = 0x034C4, // 4.0.6a 13623 (might be 0x0E476)
        ...
        SMSG_ATTACKSTOP                                      = 0x06DCC, // 4.0.6a 13623 (might be 0x035E0)
        SMSG_ATTACKSWING_NOTINRANGE                          = 0x036C4, // 4.0.6a 13623
        SMSG_ATTACKSWING_BADFACING                           = 0x067A8, // 4.0.6a 13623
        SMSG_INSTANCE_LOCK_WARNING_QUERY                     = 0x0B574, // 4.0.3a 13329
        ...
        SMSG_RESURRECT_REQUEST                               = 0x0F3A0, // 4.0.6a 13623 (might be 0x022A4)
        ...
        SMSG_PET_NAME_INVALID                                = 0x01457, // 4.0.3a 13329
        ...
        SMSG_QUESTGIVER_REQUEST_ITEMS                        = 0x06EE0, // 4.0.6a 13623 (might be 0x023A8)
        CMSG_QUESTGIVER_REQUEST_REWARD                       = 0x023A8, // 4.0.6a 13623 (might be 0x00E7D)
        ...
        SMSG_QUESTGIVER_QUEST_COMPLETE                       = 0x0050E, // 4.0.6a 13623 (might be 0x0F5C0)
        ...
        SMSG_QUESTLOG_FULL                                   = 0x061EC, // 4.0.6a 13623 (might be 0x0618C)
        ...
        SMSG_TRAINER_LIST                                    = 0x0BBE0, // 4.0.6a 13623 (might be 0x06DEC)
        ...
        CMSG_WRAP_ITEM                                       = 0x06E54, // 4.0.3a 13329
        SMSG_LEVELUP_INFO                                    = 0x0B9C4, // 4.0.6a 13623
        MSG_MINIMAP_PING                                     = 0x033A0, // 4.0.6a 13623 (might be 0x0C475)
        ...
        SMSG_START_MIRROR_TIMER                              = 0x0B4A8, // 4.0.6a 13623 (might be 0x0A68C)
        SMSG_PAUSE_MIRROR_TIMER                              = 0x021EC, // 4.0.6a 13623
        SMSG_STOP_MIRROR_TIMER                               = 0x0A68C, // 4.0.6a 13623 (might be 0x0B4A8)
        ...
        CMSG_PET_CAST_SPELL                                  = 0x02888, // 4.0.6a 13623 (might be 0x0B6A4)
        ...
        CMSG_PLAYER_DIFFICULTY_CHANGE                        = 0x07E5D, // 4.0.3a 13329
        ...
        SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT                  = 0x0EDA4, // 4.0.6a 13623 (might be SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE)
        SMSG_GAMEOBJECT_DESPAWN_ANIM                         = 0x0BFA8, // 4.0.6a 13623
        MSG_CORPSE_QUERY                                     = 0x0E0C8, // 4.0.6a 13623 (might be 0x0F388)
        ...
        CMSG_GUILD_SWITCH_RANK                               = 0x100A6, // Unknown opcode ID
        ...
        CMSG_BATTLEFIELD_LIST                                = 0x00093, // 4.0.6a 13623 (might be 0x00508)
        ...
        CMSG_TAXICLEARNODE                                   = 0x100AD, // Unknown opcode ID
        CMSG_TAXIENABLENODE                                  = 0x100AE, // Unknown opcode ID
        ...
        SMSG_RESURRECT_FAILED                                = 0x0D557, // 4.0.3a 13329
        ...
        SMSG_AUCTION_LIST_RESULT                             = 0x0A1A8, // 4.0.6a 13623 (might be 0x0E5A8)
        ...
        SMSG_AUCTION_BIDDER_LIST_RESULT                      = 0x0E5A8, // 4.0.6a 13623 (might be 0x0A1A8)
        ...
        SMSG_SPELLDISPELLOG                                  = 0xA9C8, // 4.0.6a 136230 (might be 0x03C56)
        ...
        CMSG_GROUP_SWAP_SUB_GROUP                            = 0x031C8, // 4.0.6a 13623 (might be 0x0677F)
        ...
        SMSG_MEETINGSTONE_SETQUEUE                           = 0x0ED88, // 4.0.6a 13623 (almost 99.9% sure it's wrong)
        ...
        CMSG_BATTLEMASTER_HELLO                              = 0x06D57, // 4.0.3a 13329
        ...
        SMSG_FORCE_TURN_RATE_CHANGE                          = 0x0A3A8, // 4.0.6a 13623 (might be 0x0375E)
        ...
        CMSG_BATTLEMASTER_JOIN                               = 0x00C91, // 4.0.6a 13623
        ...
        SMSG_MINIGAME_SETUP                                  = 0x026A4, // 4.0.6a 13623 (might be 0x01C74)
        SMSG_MINIGAME_STATE                                  = 0x0A5A8, // 4.0.6a 13623 (might be 0x04C7F)
        ...
        SMSG_INSTANCE_DIFFICULTY                             = 0x0FFE4, // 4.0.6a 13623 (might be 0x0A55E)
        MSG_GM_RESETINSTANCELIMIT                            = 0x1012F, // Unknown opcode ID
        SMSG_MOTD                                            = 0x077C0, // 4.0.6a 13623
        SMSG_MOVE_SET_FLIGHT                                 = 0x0C57F, // 4.0.3a 13329
        ...
        CMSG_SEARCH_LFG_LEAVE                                = 0x0847D, // 4.0.3a 13329
        ...
        CMSG_LFG_SET_BOOT_VOTE                               = 0x0AA84, // 4.0.6a 13623 (might be 0x0D65D)
        SMSG_LFG_BOOT_PROPOSAL_UPDATE                        = 0x079AC, // 4.0.6a 13623
        CMSG_LFD_PLAYER_LOCK_INFO_REQUEST                    = 0x0E5E8, // 4.0.6a 13623 (might be 0x00C76)
        SMSG_LFG_PLAYER_INFO                                 = 0x0E088, // 4.0.6a 13623
        CMSG_LFG_TELEPORT                                    = 0x0FA88, // 4.0.6a 13623
        CMSG_LFD_PARTY_LOCK_INFO_REQUEST                     = 0x00574, // 4.0.3a 13329
        ...
        SMSG_FORCE_FLIGHT_BACK_SPEED_CHANGE                  = 0x10153, // (might be 0x0B484)
        ...
        SMSG_RESET_FAILED_NOTIFY                             = 0x0BD5C, // 4.0.3a 13329
        ...
        CMSG_BOT_DETECTED                                    = 0x0E757, // 4.0.3a 13329
        ...
        CMSG_CHANNEL_VOICE_ON                                = 0x05A98, // 4.0.3a 13329
        CMSG_CHANNEL_VOICE_OFF                               = 0x07A88, // 4.0.3a 13329
        ...
        CMSG_ADD_VOICE_IGNORE                                = 0x0EF75, // 4.0.3a 13329
        CMSG_DEL_VOICE_IGNORE                                = 0x0BD7E, // 4.0.3a 13329
        CMSG_PARTY_SILENCE                                   = 0x06CC4, // 4.0.6a 13623 (might be 0x0F755)
        CMSG_PARTY_UNSILENCE                                 = 0x0FCA4, // 4.0.6a 13623 (might be 0x02F7D)
        MSG_NOTIFY_PARTY_SQUELCH                             = 0x0E8E8, // 4.0.6a 13623
        SMSG_COMSAT_RECONNECT_TRY                            = 0x07E7E, // 4.0.3a 13329
        SMSG_COMSAT_DISCONNECT                               = 0x02E57, // 4.0.3a 13329
        SMSG_COMSAT_CONNECT_FAIL                             = 0x0647E, // 4.0.3a 13329
        ...
        SMSG_VOICESESSION_FULL                               = 0x0A456, // 4.0.3a 13329
        ...
        SMSG_IGNORE_DIMINISHING_RETURNS_CHEAT                = 0x0747E, // 4.0.3a 13329
        CMSG_KEEP_ALIVE                                      = 0x02CE0, // 4.0.6a 13623
        SMSG_RAID_READY_CHECK_ERROR                          = 0x0547E, // 4.0.3a 13329
        ...
        SMSG_GROUPACTION_THROTTLED                           = 0x101A5, // Unknown opcode ID
        SMSG_OVERRIDE_LIGHT                                  = 0x00756, // 4.0.3a 13329
        ...
        SMSG_PROPOSE_LEVEL_GRANT                             = 0x0E0C4, // 4.0.6a 13623 (might be 0x0B476)
        CMSG_ACCEPT_LEVEL_GRANT                              = 0x0B5CC, // 4.0.6a 13623
        SMSG_REFER_A_FRIEND_FAILURE                          = 0x07F7C, // 4.0.6a 13623
        SMSG_SPLINE_MOVE_SET_FLYING                          = 0x05D54, // 4.0.3a 13329
        ...
        SMSG_FORCE_PITCH_RATE_CHANGE                         = 0x0ABA4, // 4.0.6a 13623
        ...
        CMSG_UPDATE_MISSILE_TRAJECTORY                       = 0x00E54, // 4.0.3a 13329
        ...
        SMSG_CRITERIA_UPDATE                                 = 0x0AFC8, // 4.0.6a 13623 (might be 0x00470)
        CMSG_QUERY_INSPECT_ACHIEVEMENTS                      = 0x069A0, // 4.0.6a 13623 (might be 0x028EC)
        ...
        CMSG_PET_UNLEARN_TALENTS                             = 0x08F5D, // 4.0.3a 13329
        ...
        SMSG_HIGHEST_THREAT_UPDATE                           = 0x03F7E, // 4.0.3a 13329
        ...
        CMSG_HEARTH_AND_RESURRECT                            = 0x0D67E, // 4.0.3a 13329
        ...
        CMSG_QUERY_VEHICLE_STATUS                            = 0x101F0, // 4.0.6a 1623 (might be 0x069A0)
        SMSG_BATTLEGROUND_INFO_THROTTLED                     = 0x075C4, // 4.0.6a 13623 (might be 0x004A6)
        ...
        CMSG_CALENDAR_CONTEXT_EVENT_SIGNUP                   = 0x0AEAC, // 4.0.6a 13623 (might be 0x0DC74)
        SMSG_CALENDAR_ACTION_PENDING                         = 0x07E8C, // 4.0.6a 13623 (might be 0x0265E)
        SMSG_EQUIPMENT_SET_LIST                              = 0x0F1A8, // 4.0.6a 13623
        CMSG_EQUIPMENT_SET_SAVE                              = 0x0BFC0, // 4.0.6a 13623
        CMSG_UPDATE_PROJECTILE_POSITION                      = 0x0EF7F, // 4.0.3a 13329
        ...
        SMSG_FORCE_UNK1_SPEED_CHANGE                         = 0x10219, // Unknown opcode ID
        CMSG_FORCE_UNK1_SPEED_CHANGE_ACK                     = 0x0F0C0, // 4.0.6a 13623
        SMSG_FORCE_UNK2_SPEED_CHANGE                         = 0x1021B, // Unknown opcode ID
        ...
        CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE           = 0x00005, // 4.0.6a 13623 (might be 0x00100)
        SMSG_BATTLEFIELD_MGR_ENTERED                         = 0x0415C, // 4.0.6a 13623 (might be 0x00004)
        SMSG_BATTLEFIELD_MGR_QUEUE_INVITE                    = 0x0054C, // 4.0.6a 13623
        CMSG_BATTLEFIELD_MGR_QUEUE_INVITE_RESPONSE           = 0x08108, // 4.0.6a 13623
        CMSG_BATTLEFIELD_MGR_QUEUE_REQUEST                   = 0x00611, // 4.0.6a 13623 (might be 0x0011D)
        SMSG_BATTLEFIELD_MGR_QUEUE_REQUEST_RESPONSE          = 0x00C0C, // 4.0.6a 13623 (might be 0x0011C)
        SMSG_BATTLEFIELD_MGR_EJECT_PENDING                   = 0x0045E, // 4.0.6a 13623 (might be 0x0011B)
        SMSG_BATTLEFIELD_MGR_EJECTED                         = 0x04C1C, // 4.0.6a 13623 (might be 0x0011A)
        CMSG_BATTLEFIELD_MGR_EXIT_REQUEST                    = 0x08581, // 4.0.6a 13623 (might be 0x08580)
        SMSG_BATTLEFIELD_MGR_STATE_CHANGE                    = 0x0485C, // 4.0.6a 13623 (might be 0x0352D)
        ...
        SMSG_UNKNOWN_1276                                    = 0x00508, // 4.0.6a 13623 (might be 0x0093)
        ...
        SMSG_CAMERA_SHAKE                                    = 0x1009E, // Unknown opcode ID
        ...
        SMSG_UNKNOWN_1295                                    = 0x10008, // Unknown opcode ID
        CMSG_UNKNOWN_1296                                    = 0x10009, // Unknown opcode ID
        ...
        SMSG_UNKNOWN_1302                                    = 0x10010, // Unknown opcode ID
        ...
        SMSG_UNKNOWN_1308                                    = 0x10011, // Unknown opcode ID
        ...
        SMSG_SEND_QUEUED_PACKETS                             = 0x10012, // Unknown opcode ID/Name (might be 0x01400)
        CMSG_REDIRECT_AUTH_PROOF                             = 0x00100, // 4.0.6a 13623 (might be 0x08C0A)
        ...
        // Missing on 4.0.6 (or different name)
