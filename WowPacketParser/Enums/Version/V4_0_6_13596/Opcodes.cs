...
namespace WowPacketParser.Enums.Version//.V4_0_6_13596
{
    ...
    {
        private static readonly Dictionary<Opcode, int> _V4_0_6_opcodes = new Dictionary<Opcode, int>
        {
            ...
            {Opcode.CMSG_GAMETIME_SET, 0x020C4}, // 4.0.6a 13623
            {Opcode.SMSG_GAMETIME_SET, 0x07888}, // 4.0.6a 13623
            {Opcode.CMSG_GAMESPEED_SET, 0x02084}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_GUILD_XP_UPDATE, 0x0440E}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_GAMEOBJECT_CUSTOM_ANIM, 0x036A0}, // 4.0.6a 13623 (might be 0x02E8C)
            ...
            {Opcode.SMSG_FORCE_RUN_BACK_SPEED_CHANGE, 0x1002E}, // Unknown opcode ID
            ...
            {Opcode.CMSG_DESTROYITEM, 0x0B8A8}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_ATTACKSTOP, 0x06DCC}, // 4.0.6a 13623 (might be 0x035E0)
            ...
            {Opcode.SMSG_QUESTGIVER_QUEST_LIST, 0x02B88}, // 4.0.6a 13623
            ...
            {Opcode.CMSG_QUESTGIVER_CANCEL, 0x061EC}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_QUESTLOG_FULL, 0x061EC}, // 4.0.6a 13623 (might be 0x0618C)
            ...
            {Opcode.SMSG_BUY_BANK_SLOT_RESULT, 0x0F5C0}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_UPDATE_INSTANCE_ENCOUNTER_UNIT, 0x0EDA4}, // 4.0.6a 13623 (might be SMSG_GAMEOBJECT_SPAWN_ANIM_OBSOLETE)
            ...
            {Opcode.SMSG_SPIRIT_HEALER_CONFIRM, 0x0B9C0}, // 4.0.6a 13623
            ...
            {Opcode.CMSG_BATTLEFIELD_LIST, 0x00093}, // 4.0.6a 13623 (might be 0x00508)
            {Opcode.SMSG_BATTLEFIELD_LIST, 0x0490C}, // 4.0.6a 13623
            {Opcode.CMSG_BATTLEFIELD_JOIN, 0x00C91}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_STANDSTATE_CHANGE_FAILURE_OBSOLETE, 0x06DCC}, // 4.0.6a 13623
            ...
            {Opcode.CMSG_SET_AMMO, 0x100BF}, // Unknown opcode ID
            ...
            {Opcode.SMSG_ITEM_NAME_QUERY_RESPONSE, 0x07BC8}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_BATTLEFIELD_STATUS1, 0x0454C}, // 4.0.6a 13623
            {Opcode.SMSG_BATTLEFIELD_STATUS2, 0x0051E}, // 4.0.6a 13623
            {Opcode.SMSG_BATTLEFIELD_STATUS3, 0x0081C}, // 4.0.6a 13623
            {Opcode.SMSG_BATTLEFIELD_STATUS4, 0x04C4C}, // 4.0.6a 13623
            {Opcode.CMSG_BATTLEFIELD_PORT, 0x00E11}, // 4.0.6a 13623
            ...
            {Opcode.CMSG_BATTLEMASTER_JOIN, 0x00C91}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_SPLINE_SET_RUN_SPEED, 0x0F9E8}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_RUN_BACK_SPEED, 0x0E9C0}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_SWIM_SPEED, 0x0B2C0}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_WALK_SPEED, 0x03EA8}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_SWIM_BACK_SPEED, 0x021C8}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_TURN_RATE, 0x07EAC}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_SPLINE_SET_FLIGHT_SPEED, 0x0E0C0}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_FLIGHT_BACK_SPEED, 0x0F2EC}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_COMMENTATOR_GET_PLAYER_INFO, 0x0758C}, // 4.0.6a 13623
            {Opcode.SMSG_COMMENTATOR_PLAYER_INFO, 0x0758C}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_FORCE_PITCH_RATE_CHANGE, 0x0ABA4}, // 4.0.6a 13623
            {Opcode.CMSG_FORCE_PITCH_RATE_CHANGE_ACK, 0x0E6C0}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_SET_PITCH_RATE, 0x070C4}, // 4.0.6a 13623
            ...
            {Opcode.SMSG_BATTLEGROUND_INFO_THROTTLED, 0x075C4}, // 4.0.6a 13623 (might be 0x004A6)
            ...
            {Opcode.CMSG_FORCE_UNK2_SPEED_CHANGE_ACK, 0x07DE8}, // 4.0.6a 13623
            {Opcode.SMSG_MOVE_LEVITATING, 0x0B8AC}, // 4.0.6a 13623
            {Opcode.SMSG_SPLINE_MOVE_UNKNOWN_1235, 0x1021E}, // Unknown opcode ID
            {Opcode.SMSG_SPLINE_MOVE_UNKNOWN_1236, 0x1022F}, // 4.0.6a 13623
            ...
            {Opcode.CMSG_BATTLEFIELD_MGR_ENTRY_INVITE_RESPONSE, 0x00005}, // 4.0.6a 13623 (might be 0x00100)
            ...
            {Opcode.CMSG_BATTLEFIELD_MGR_EXIT_REQUEST, 0x08581}, // 4.0.6a 13623 (might be 0x08580)
            ...
            {Opcode.SMSG_UNKNOWN_1276, 0x00508}, // 4.0.6a 13623 (might be 0x0093)
            ...
            {Opcode.SMSG_FORCE_SEND_QUEUED_PACKETS, 0x06EC8}, // 4.0.6a 13623
            ...
            {Opcode.CMSG_REFORGE, 0x00313}, // 4.0.6a 13623
