...
namespace WowPacketParser.Enums
{
    ...
    public enum CustomizationFlag
    {
        ...
        RaceChangeDisabled = 0x10000000 // Paid Race Change is currently disabled for this character.|nThis is due to not finishing the quests in this character's starting area.
    }
}
