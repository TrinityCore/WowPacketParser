...
namespace WowPacketParserModule.V8_0_1_27101.UpdateFields.V8_1_5_29683
{
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public static IItemEnchantment ReadCreateItemEnchantment(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public override IItemData ReadCreateItemData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.Modifiers.FillAll((i) => { return packet.ReadInt32("Modifiers", indexes, i); });
            data.ArtifactPowers.FillAll((i) => { return ReadCreateArtifactPower(packet, flags, indexes, "ArtifactPowers", i); });
            data.Gems.FillAll((i) => { return ReadCreateSocketedGem(packet, flags, indexes, "Gems", i); });
            return data;
        }
        ...
        public override IItemData ReadUpdateItemData(Packet packet, IItemData existingData, params object[] indexes)
        {
            ...
            if (changesMask[0])
            {
                if (changesMask[2])
                {
                    data.Modifiers.FillAllByUpdateMask((i) => { return packet.ReadInt32("Modifiers", indexes, i); });
                }
                if (changesMask[3])
                {
        ...
        public override IUnitData ReadCreateUnitData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.PassiveSpells.FillAll((i) => { return ReadCreatePassiveSpellHistory(packet, flags, indexes, "PassiveSpells", i); });
        ...
        public override IPlayerData ReadCreatePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.ArenaCooldowns.FillAll((i) => { return ReadCreateArenaCooldown(packet, flags, indexes, "ArenaCooldowns", i); });
            return data;
        }
        ...
        public override IActivePlayerData ReadCreateActivePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            for (var i = 0; i < 1; ++i)
            {
                ...
                data.Research[i].FillAll((j) => { return ReadCreateResearch(packet, flags, indexes, "Research", i, j); });
            }
            ...
            data.SpellPctModByLabel.FillAll((i) => { return ReadCreateSpellPctModByLabel(packet, flags, indexes, "SpellPctModByLabel", i); });
            data.SpellFlatModByLabel.FillAll((i) => { return ReadCreateSpellFlatModByLabel(packet, flags, indexes, "SpellFlatModByLabel", i); });
            ...
            data.CharacterRestrictions.FillAll((i) => { return ReadCreateCharacterRestriction(packet, flags, indexes, "CharacterRestrictions", i); });
            for (var i = 0; i < 6; ++i)
            {
        ...
        public override IConversationData ReadCreateConversationData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.Actors.FillAll((i) => { return ReadCreateConversationActor(packet, flags, indexes, "Actors", i); });
            return data;
        }
