...
namespace WowPacketParserModule.V8_0_1_27101.UpdateFields.V8_1_5_29495
{
    ...
    {
        public static ObjectData ReadCreateObjectData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ItemEnchantment ReadCreateItemEnchantment(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ArtifactPower ReadCreateArtifactPower(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static SocketedGem ReadCreateSocketedGem(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ItemData ReadCreateItemData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            for (var i = 0; i < 13; ++i)
            {
                data.Enchantment[i] = ReadCreateItemEnchantment(packet, flags, indexes, "Enchantment", i);
            }
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
            ...
            {
                data.ArtifactPowers[i] = ReadCreateArtifactPower(packet, flags, indexes, "ArtifactPowers", i);
            }
            for (var i = 0; i < data.Gems.Count; ++i)
            {
                data.Gems[i] = ReadCreateSocketedGem(packet, flags, indexes, "Gems", i);
            }
            return data;
        }
        ...
        public static ContainerData ReadCreateContainerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static AzeriteEmpoweredItemData ReadCreateAzeriteEmpoweredItemData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static AzeriteItemData ReadCreateAzeriteItemData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
                ...
                data.DEBUGknowledgeWeek = packet.ReadUInt32("DEBUGknowledgeWeek", indexes);
            }
            return data;
        }
        ...
        public static UnitChannel ReadCreateUnitChannel(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static VisibleItem ReadCreateVisibleItem(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static PassiveSpellHistory ReadCreatePassiveSpellHistory(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static UnitData ReadCreateUnitData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.ChannelData = ReadCreateUnitChannel(packet, flags, indexes, "ChannelData");
            ...
            for (var i = 0; i < 3; ++i)
            {
                data.VirtualItems[i] = ReadCreateVisibleItem(packet, flags, indexes, "VirtualItems", i);
            }
            ...
            {
                data.PassiveSpells[i] = ReadCreatePassiveSpellHistory(packet, flags, indexes, "PassiveSpells", i);
            }
        ...
        public static QuestLog ReadCreateQuestLog(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ArenaCooldown ReadCreateArenaCooldown(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static PlayerData ReadCreatePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            if ((flags & UpdateFieldFlag.PartyMember) != UpdateFieldFlag.None)
            {
                for (var i = 0; i < 100; ++i)
                {
                    data.QuestLog[i] = ReadCreateQuestLog(packet, flags, indexes, "QuestLog", i);
                }
            }
            for (var i = 0; i < 19; ++i)
            {
                data.VisibleItems[i] = ReadCreateVisibleItem(packet, flags, indexes, "VisibleItems", i);
            }
            ...
            {
                data.ArenaCooldowns[i] = ReadCreateArenaCooldown(packet, flags, indexes, "ArenaCooldowns", i);
            }
            return data;
        }
        ...
        public static SkillInfo ReadCreateSkillInfo(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static RestInfo ReadCreateRestInfo(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static PVPInfo ReadCreatePVPInfo(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static CharacterRestriction ReadCreateCharacterRestriction(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static SpellPctModByLabel ReadCreateSpellPctModByLabel(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static SpellFlatModByLabel ReadCreateSpellFlatModByLabel(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static Research ReadCreateResearch(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ActivePlayerData ReadCreateActivePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.Skill = ReadCreateSkillInfo(packet, flags, indexes, "Skill");
            ...
            for (var i = 0; i < 2; ++i)
            {
                data.RestInfo[i] = ReadCreateRestInfo(packet, flags, indexes, "RestInfo", i);
            }
            for (var i = 0; i < 7; ++i)
            {
            ...
            for (var i = 0; i < 1; ++i)
            {
                ...
                {
                    data.Research[i][j] = ReadCreateResearch(packet, flags, indexes, "Research", i, j);
                }
            }
            ...
            {
                data.SpellPctModByLabel[i] = ReadCreateSpellPctModByLabel(packet, flags, indexes, "SpellPctModByLabel", i);
            }
            for (var i = 0; i < data.SpellFlatModByLabel.Count; ++i)
            {
                data.SpellFlatModByLabel[i] = ReadCreateSpellFlatModByLabel(packet, flags, indexes, "SpellFlatModByLabel", i);
            }
            ...
            {
                data.CharacterRestrictions[i] = ReadCreateCharacterRestriction(packet, flags, indexes, "CharacterRestrictions", i);
            }
            for (var i = 0; i < 6; ++i)
            {
                data.PvpInfo[i] = ReadCreatePVPInfo(packet, flags, indexes, "PvpInfo", i);
            }
            return data;
        }
        ...
        public static ActivePlayerData ReadUpdateActivePlayerData(Packet packet, IActivePlayerData existingData, params object[] indexes)
        {
            ...
            for (var i = 0; i < 1; ++i)
                rawMaskMask[i] = packet.ReadInt32();
            rawMaskMask[1] = (int)packet.ReadBits(14);
            var maskMask = new BitArray(rawMaskMask);
            for (var i = 0; i < 46; ++i)
                if (maskMask[i])
                    rawChangesMask[i] = (int)packet.ReadBits(32);
        ...
        public static GameObjectData ReadCreateGameObjectData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.ArtKit = packet.ReadByte("ArtKit", indexes);
        ...
        public static DynamicObjectData ReadCreateDynamicObjectData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static CorpseData ReadCreateCorpseData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static AreaTriggerData ReadCreateAreaTriggerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new AreaTriggerData();
            data.OverrideScaleCurve = ReadCreateScaleCurve(packet, flags, indexes, "OverrideScaleCurve");
            data.Caster = packet.ReadPackedGuid128("Caster", indexes);
            data.Duration = packet.ReadUInt32("Duration", indexes);
            ...
            data.ExtraScaleCurve = ReadCreateScaleCurve(packet, flags, indexes, "ExtraScaleCurve");
            return data;
        }
        ...
        public static SceneObjectData ReadCreateSceneObjectData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ConversationLine ReadCreateConversationLine(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ConversationActor ReadCreateConversationActor(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public static ConversationData ReadCreateConversationData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            {
                data.Actors[i] = ReadCreateConversationActor(packet, flags, indexes, "Actors", i);
            }
            return data;
        }
