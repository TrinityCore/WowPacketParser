...
namespace WowPacketParserModule.V8_0_1_27101.UpdateFields.V8_2_0_30898
{
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public override IItemData ReadCreateItemData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.Modifiers.FillAll((i) =>
            {
                return packet.ReadInt32("Modifiers", indexes, i);
            });
            data.ArtifactPowers.FillAll((i) =>
            {
                return ReadCreateArtifactPower(packet, indexes, "ArtifactPowers", i);
            });
            data.Gems.FillAll((i) =>
            {
                return ReadCreateSocketedGem(packet, indexes, "Gems", i);
            });
            return data;
        }
        ...
        public override IAzeriteItemData ReadCreateAzeriteItemData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.UnlockedEssences.FillAll((i) =>
            {
                return ReadCreateUnlockedAzeriteEssence(packet, indexes, "UnlockedEssences", i);
            });
            data.UnlockedEssenceMilestones.FillAll((i) =>
            {
                return packet.ReadUInt32("UnlockedEssenceMilestones", indexes, i);
            });
            data.SelectedEssences.FillAll((i) =>
            {
                return ReadCreateSelectedAzeriteEssences(packet, indexes, "SelectedEssences", i);
            });
            return data;
        }
        ...
        public override IAzeriteItemData ReadUpdateAzeriteItemData(Packet packet, IAzeriteItemData existingData, params object[] indexes)
        {
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.UnlockedEssences.UpdateAllByUpdateMask((i, item) => ReadUpdateUnlockedAzeriteEssence(packet, item as UnlockedAzeriteEssence, indexes, "UnlockedEssences", i));
                }
                if (changesMask[3])
                {
                    data.UnlockedEssenceMilestones.FillAllByUpdateMask((i) => packet.ReadUInt32("UnlockedEssenceMilestones", indexes, i));
                }
                if (changesMask[2])
                {
                    data.SelectedEssences.UpdateAllByUpdateMask((i, item) => ReadUpdateSelectedAzeriteEssences(packet, item as SelectedAzeriteEssences, indexes, "SelectedEssences", i));
                }
                if (changesMask[4])
                {
                    data.Xp = packet.ReadUInt64("Xp", indexes);
        ...
        public override IUnitData ReadCreateUnitData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.PassiveSpells.FillAll((i) => ReadCreatePassiveSpellHistory(packet, indexes, "PassiveSpells", i));
            data.WorldEffects.FillAll((i) => packet.ReadInt32("WorldEffects", indexes, i));
            data.ChannelObjects.FillAll((i) => packet.ReadPackedGuid128("ChannelObjects", indexes, i));
            return data;
        }
        ...
        public override IUnitData ReadUpdateUnitData(Packet packet, IUnitData existingData, params object[] indexes)
        {
            ...
            if (changesMask[0])
            {
                if (changesMask[2])
                {
                    data.PassiveSpells.UpdateAllByUpdateMask((i, item) => ReadUpdatePassiveSpellHistory(packet, item as PassiveSpellHistory, indexes, "PassiveSpells", i));
                }
                if (changesMask[3])
                {
                    data.WorldEffects.FillAllByUpdateMask((i) => packet.ReadInt32("WorldEffects", indexes, i));
                }
                if (changesMask[4])
                {
                    data.ChannelObjects.FillAllByUpdateMask((i) => packet.ReadPackedGuid128("ChannelObjects", indexes, i));
                }
                if (changesMask[5])
                {
                    data.DisplayID = packet.ReadInt32("DisplayID", indexes);
        ...
        public override IPlayerData ReadCreatePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.ArenaCooldowns.FillAll((i) => ReadCreateArenaCooldown(packet, indexes, "ArenaCooldowns", i));
            return data;
        }
        ...
        public override IPlayerData ReadUpdatePlayerData(Packet packet, IPlayerData existingData, params object[] indexes)
        {
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.ArenaCooldowns.UpdateAllByUpdateMask((i, item) => ReadUpdateArenaCooldown(packet, item as ArenaCooldown, indexes, "ArenaCooldowns", i));
                }
                if (changesMask[2])
                {
                    data.DuelArbiter = packet.ReadPackedGuid128("DuelArbiter", indexes);
