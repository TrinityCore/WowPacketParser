...
namespace WowPacketParserModule.V8_0_1_27101.UpdateFields.V8_2_5_31921
{
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public override IPlayerData ReadCreatePlayerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.Field_F8 = packet.ReadPackedGuid128("Field_F8", indexes);
            data.Field_108 = packet.ReadInt32("Field_108", indexes);
            if ((flags & UpdateFieldFlag.PartyMember) != UpdateFieldFlag.None)
            {
        ...
        public override IActivePlayerData ReadUpdateActivePlayerData(Packet packet, IActivePlayerData existingData, params object[] indexes)
        {
            ...
            if (changesMask[98])
            {
                ...
                if (changesMask[103])
                {
                    if (hasQuestSession)
                    {
                        data.QuestSession = ReadUpdateQuestSession(packet, data.QuestSession as QuestSession, indexes, "QuestSession");
                    }
                }
            }
            if (changesMask[104])
