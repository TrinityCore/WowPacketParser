    ...
    public static class EquipmentSetHandler
    {
        ...
        public static void HandleEquipmentSetList(Packet packet)
        {
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                for (var j = 0; j < NumSlots; j++)
                {
                    ...
                    packet.Translator.StartBitStream(guid1[i][j], 6, 7, 5, 1, 0, 4, 2, 3);
                }
            ...
            for (var i = 0; i < count; i++)
            {
                for (var j = 0; j < NumSlots; j++)
                {
                    packet.Translator.ParseBitStream(guid1[i][j], 7, 4, 5, 3, 0, 6, 2, 1);
        ...
        public static void HandleEquipmentSetUse(Packet packet)
        {
            ...
            for (var i = 0; i < 19; ++i)
            {
                ...
                packet.Translator.StartBitStream(itemGuids[i], 6, 1, 5, 2, 0, 4, 3, 7);
            }
            ...
            for (var i = 0; i < 19; ++i)
            {
                packet.Translator.ParseBitStream(itemGuids[i], 1, 6, 4, 7, 0, 3, 5, 2);
