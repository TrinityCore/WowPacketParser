...
namespace WowPacketParserModule.V11_0_0_55666.UpdateFields.V11_2_7_64632
{
    ...
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public static IDecorStoragePersistedDataDyes ReadCreateDecorStoragePersistedDataDyes(Packet packet, params object[] indexes)
        {
            var data = new DecorStoragePersistedDataDyes();
            packet.ResetBitReader();
            for (var i = 0; i < 3; ++i)
            {
        ...
        public static IDecorStoragePersistedDataDyes ReadUpdateDecorStoragePersistedDataDyes(Packet packet, params object[] indexes)
        {
            var data = new DecorStoragePersistedDataDyes();
            packet.ResetBitReader();
            for (var i = 0; i < 3; ++i)
        ...
        public static IDecorStoragePersistedData ReadCreateDecorStoragePersistedData(Packet packet, params object[] indexes)
        {
            ...
            if (hasDyes)
            {
                data.Dyes = ReadCreateDecorStoragePersistedDataDyes(packet, indexes, "Dyes");
            }
            return data;
        }
        ...
        public override IHousingPlayerHouseData ReadCreateHousingPlayerHouseData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.Level = packet.ReadUInt32("Level", indexes);
            data.Field_20 = packet.ReadUInt64("Field_20", indexes);
        ...
        public static IPlayerMirrorHouse ReadCreatePlayerMirrorHouse(Packet packet, params object[] indexes)
        {
            ...
            data.Field_28 = packet.ReadInt32("Field_28", indexes);
            return data;
        }
        ...
        public override IPlayerHouseInfoComponentData ReadCreatePlayerHouseInfoComponentData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
                ...
                data.Field_40 = packet.ReadPackedGuid128("Field_40", indexes);
            }
            data.Houses.Resize(packet.ReadUInt32());
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
        ...
        public override IHousingStorageData ReadCreateHousingStorageData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            {
                var key = packet.ReadPackedGuid128("Key", indexes, m);
                data.Decor[key] = ReadCreateDecorStoragePersistedData(packet, indexes, "Value", m);
            }
                ...
                if (changesMask[1])
                {
                    ...
                    else
                    {
                        ...
                        for (var m = 0u; m < changesCountDecor; ++m)
                        {
                            ...
                            if (changeType == 2)
                                continue;
                            data.Decor[key] = ReadUpdateDecorStoragePersistedData(packet, indexes, "Value", m);
                        }
                    }
                }
                if (changesMask[2])
