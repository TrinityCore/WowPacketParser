...
namespace WowPacketParserModule.V11_0_0_55666.UpdateFields.V11_0_0_55666
{
    ...
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public override IUnitData ReadCreateUnitData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.MaxHealthModifierFlatNeg = packet.ReadUInt32("MaxHealthModifierFlatNeg", indexes);
            data.MaxHealthModifierFlatPos = packet.ReadUInt32("MaxHealthModifierFlatPos", indexes);
