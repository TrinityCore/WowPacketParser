...
namespace WowPacketParserModule.V3_4_0_45166.Parsers
{
    public static class MailHandler
    {
        ...
        [Parser(Opcode.SMSG_MAIL_QUERY_NEXT_TIME_RESULT, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_MAIL_COMMAND_RESULT, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_MAIL_LIST_RESULT, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_NOTIFY_RECEIVED_MAIL, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleNotifyReceivedMail(Packet packet)
        {
            packet.ReadSingle("Delay");
        }

        [Parser(Opcode.CMSG_MAIL_CREATE_TEXT_ITEM, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_MAIL_DELETE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_MAIL_GET_LIST, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleGetMailList(Packet packet)
        {
            packet.ReadPackedGuid128("Mailbox");
        }

        [Parser(Opcode.CMSG_MAIL_MARK_AS_READ, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_MAIL_RETURN_TO_SENDER, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_MAIL_TAKE_ITEM, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_MAIL_TAKE_MONEY, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_SEND_MAIL, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_QUERY_NEXT_MAIL_TIME, ClientVersionBuild.V3_4_4_59817)]
