...
namespace WowPacketParserModule.V3_4_0_45166.Parsers
{
    public static class ScenarioHandler
    {
        ...
        [Parser(Opcode.SMSG_SCENARIO_COMPLETED, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleScenarioCompleted(Packet packet)
        {
            packet.ReadInt32("ScenarioID");
        }

        [Parser(Opcode.SMSG_SCENARIO_POIS, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_SCENARIO_PROGRESS_UPDATE, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleScenarioProgressUpdate(Packet packet)
        {
            AchievementHandler.ReadCriteriaProgress(packet, "Progress");
        }

        [Parser(Opcode.SMSG_SCENARIO_STATE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_SCENARIO_VACATE, ClientVersionBuild.V3_4_4_59817)]
