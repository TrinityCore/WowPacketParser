...
namespace WowPacketParserModule.V3_4_0_45166.Parsers
{
    public static class MovementHandler
    {
        ...
        public static void ReadMovementMonsterSpline(Packet packet, Vector3 pos, params object[] indexes)
        {
            ...
            if (ClientVersion.RemovedInVersion(ClientBranch.Classic, ClientVersionBuild.V1_15_1_53247) || ClientVersion.Branch != ClientBranch.Classic)
        ...
        [Parser(Opcode.SMSG_ON_MONSTER_MOVE, ClientBranch.Classic, ClientVersionBuild.V1_15_1_53247)]
