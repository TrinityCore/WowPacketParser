...
namespace WowPacketParserModule.V3_4_0_45166.Parsers
{
    public static class ContactHandler
    {
        ...
        [Parser(Opcode.SMSG_CONTACT_LIST, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_FRIEND_STATUS, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_ADD_FRIEND, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_ADD_IGNORE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_DEL_FRIEND, ClientVersionBuild.V3_4_4_59817)]
        [Parser(Opcode.CMSG_DEL_IGNORE, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleDeleteFriendOrIgnoreOrMute(Packet packet)
        {
            ReadQualifiedGUID(packet, "QualifiedGUID");
        }

        [Parser(Opcode.CMSG_DUEL_RESPONSE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_SEND_CONTACT_LIST, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleSendContactList(Packet packet)
        {
            packet.ReadUInt32("Flags");
        }

        [Parser(Opcode.CMSG_SET_CONTACT_NOTES, ClientVersionBuild.V3_4_4_59817)]
