...
namespace WowPacketParserModule.V3_4_0_45166.Parsers
{
    public static class LfgHandler
    {
        ...
        [Parser(Opcode.SMSG_LFG_LIST_UPDATE_BLACKLIST, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_PLAYER_INFO, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_BOOT_PLAYER, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleLfgBootPlayer(Packet packet)
        {
            ReadLfgBootInfo(packet);
        }

        [Parser(Opcode.SMSG_LFG_JOIN_RESULT, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_OFFER_CONTINUE, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleLfgOfferContinue(Packet packet)
        {
            packet.ReadLfgEntry("LfgEntry");
        }

        [Parser(Opcode.SMSG_LFG_PARTY_INFO, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_PLAYER_REWARD, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_QUEUE_STATUS, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_ROLE_CHECK_UPDATE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_TELEPORT_DENIED, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_ROLE_CHOSEN, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_DF_BOOT_PLAYER_VOTE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_DF_LEAVE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_DF_TELEPORT, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_LFG_DISABLED, ClientVersionBuild.V3_4_4_59817)]
