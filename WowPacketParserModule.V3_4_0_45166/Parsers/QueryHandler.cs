...
namespace WowPacketParserModule.V3_4_0_45166.Parsers
{
    public static class QueryHandler
    {
        ...
        [HasSniffData]
        [Parser(Opcode.SMSG_QUERY_CREATURE_RESPONSE, ClientVersionBuild.V3_4_0_44832, ClientVersionBuild.V3_4_4_59817)]
        ...
        [HasSniffData]
        [Parser(Opcode.SMSG_QUERY_CREATURE_RESPONSE, ClientVersionBuild.V3_4_4_59817)]
        public static void HandleCreatureQueryResponse344(Packet packet)
        {
            PacketQueryCreatureResponse response = packet.Holder.QueryCreatureResponse = new PacketQueryCreatureResponse();
            var entry = packet.ReadEntry("Entry");
        ...
        [Parser(Opcode.CMSG_QUERY_PLAYER_NAMES, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_QUERY_QUEST_INFO, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.SMSG_QUERY_PLAYER_NAMES_RESPONSE, ClientVersionBuild.V3_4_4_59817)]
        ...
        [Parser(Opcode.CMSG_QUERY_NPC_TEXT, ClientVersionBuild.V3_4_4_59817)]
        ...
        [HasSniffData]
        [Parser(Opcode.SMSG_QUERY_NPC_TEXT_RESPONSE, ClientVersionBuild.V3_4_4_59817)]
