...
namespace WowPacketParserModule.V4_4_0_54481.Parsers
{
    public static class CharacterHandler
    {
        ...
        public static void ReadVisualItemInfo441(Packet packet, params object[] idx)
        {
            packet.ReadUInt32("DisplayID", idx);
            packet.ReadByteE<InventoryType>("InvType", idx);
            packet.ReadUInt32("DisplayEnchantID", idx);
        ...
        public static void ReadCharacterListEntry441(Packet packet, params object[] idx)
        {
            ReadBasicCharacterListEntry(packet, idx, "Basic");
        ...
        [Parser(Opcode.SMSG_ENUM_CHARACTERS_RESULT, ClientVersionBuild.V4_4_0_54481, ClientVersionBuild.V4_4_1_57294)]
        ...
        [Parser(Opcode.SMSG_ENUM_CHARACTERS_RESULT, ClientVersionBuild.V4_4_1_57294)]
        public static void HandleEnumCharactersResult441(Packet packet)
        {
            packet.ReadBit("Success");
            ...
            for (var i = 0u; i < charsCount; ++i)
                ReadCharacterListEntry441(packet, i, "Characters");
