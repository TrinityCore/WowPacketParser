...
namespace WowPacketParserModule.V4_4_0_54481.Parsers
{
    public static class UpdateHandler
    {
        ...
        [Parser(Opcode.SMSG_UPDATE_OBJECT, ClientBranch.Cata, ClientVersionBuild.V4_4_0_54481, ClientVersionBuild.V4_4_2_59185)]
        ...
        [HasSniffData] // in ReadCreateObjectBlock
        [Parser(Opcode.SMSG_UPDATE_OBJECT, ClientBranch.Cata, ClientVersionBuild.V4_4_2_59185)]
        public static void HandleUpdateObject442(Packet packet)
        {
            var updateObject = packet.Holder.UpdateObject = new();
            ...
            for (var i = 0; i < count; i++)
            {
                ...
                switch (type)
                {
                    ...
                    case UpdateTypeCataclysm.CreateObject2:
                    {
                        var createType = type.ToCreateObjectType();
                        var createObject = new CreateObject() { Guid = guid, Values = new() { }, CreateType = createType };
                        ReadCreateObjectBlock442(packet, createObject, guid, map, createType, i);
                        createObject.Text = partWriter.Text;
                        createObject.TextStartOffset = partWriter.StartOffset;
                        createObject.TextLength = partWriter.Length;
                        updateObject.Created.Add(createObject);
        ...
        private static void ReadCreateObjectBlock442(Packet packet, CreateObject createObject, WowGuid guid, uint map, CreateObjectType createType, int index)
        {
            ObjectType objType = ObjectTypeConverter.Convert(packet.ReadByteE<ObjectType801>("Object Type", index));
