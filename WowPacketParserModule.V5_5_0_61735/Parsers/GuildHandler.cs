...
namespace WowPacketParserModule.V5_5_0_61735.Parsers
{
    public static class GuildHandler
    {
        ...
        public static void HandleGuildBankMoneyWithdrawMoney(Packet packet)
        {
        ...
        public static void HandleGuildChallengeUpdate(Packet packet)
        {
            for (int i = 0; i < 6; ++i)
        ...
        [Parser(Opcode.SMSG_GUILD_EVENT_STATUS_CHANGE)]
        public static void HandleGuildEventStatusChange(Packet packet)
        {
            packet.ReadPackedGuid128("Guid");
            packet.ReadBit("AFK");
            packet.ReadBit("DND");
        ...
        public static void HandleGuildNews(Packet packet)
        {
        ...
        public static void HandleGuildPartyState(Packet packet)
        {
        ...
        public static void HandleGuildRewardList(Packet packet)
        {
            ...
            for (int i = 0; i < size; i++)
            {
                ...
                packet.ReadUInt32("AchievementLogic", i);
        ...
        [Parser(Opcode.CMSG_GUILD_REQUEST_RENAME_STATUS)]
