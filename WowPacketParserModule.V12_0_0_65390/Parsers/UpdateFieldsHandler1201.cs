...
namespace WowPacketParserModule.V12_0_0_65390.UpdateFields.V12_0_1_65818
{
    ...
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        public override IHousingRoomData ReadCreateHousingRoomData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            ...
            data.FloorIndex = packet.ReadInt32("FloorIndex", indexes);
        ...
        public override IHousingPlotAreaTriggerData ReadCreateHousingPlotAreaTriggerData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingPlotAreaTriggerData();
            packet.ResetBitReader();
            data.PlotID = packet.ReadUInt32("PlotID", indexes);
            data.HouseOwnerGUID = packet.ReadPackedGuid128("HouseOwnerGUID", indexes);
            data.HouseGUID = packet.ReadPackedGuid128("HouseGUID", indexes);
            data.HouseOwnerBnetAccountGUID = packet.ReadPackedGuid128("HouseOwnerBnetAccountGUID", indexes);
            return data;
        }

        public override IHousingPlotAreaTriggerData ReadUpdateHousingPlotAreaTriggerData(Packet packet, params object[] indexes)
        {
            var data = new HousingPlotAreaTriggerData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static INeighborhoodCharter ReadUpdateNeighborhoodCharter(Packet packet, params object[] indexes)
        {
            ...
            for (var i = 0; i < data.Signatures.Length; ++i)
            {
                data.Signatures[i] = ReadUpdateNeighborhoodCharterSignature(packet, indexes, "Signatures", i);
            }
            packet.ResetBitReader();
            data.Name = new string('*', (int)packet.ReadBits(8));
            data.Name = packet.ReadDynamicString("Name", data.Name.Length, indexes);
        ...
        public static INICompletedInitiativesEntry ReadUpdateNICompletedInitiativesEntry(Packet packet, params object[] indexes)
        {
            ...
            for (var i = 0; i < data.CompletedMilestones.Length; ++i)
            {
                data.CompletedMilestones[i] = ReadUpdateNICompletedMilestoneEntry(packet, indexes, "CompletedMilestones", i);
            }
            packet.ResetBitReader();
            packet.ResetBitReader();
            data.Completed = packet.ReadBit("Completed", indexes);
