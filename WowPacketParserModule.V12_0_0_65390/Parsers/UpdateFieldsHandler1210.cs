...
namespace WowPacketParserModule.V12_0_0_65390.UpdateFields.V12_1_0_69214
{
    ...
    public class UpdateFieldHandler : UpdateFieldsHandlerBase
    {
        ...
        {
            return ReadCreateItemMod(packet, indexes);
        }
        ...
        {
            return ReadCreateArtifactPower(packet, indexes);
        }
        ...
        {
            return ReadCreateUnlockedAzeriteEssence(packet, indexes);
        }
        ...
        {
            return ReadCreateSpellCastVisual(packet, indexes);
        }
        ...
        {
            return ReadCreateUnitChannel(packet, indexes);
        }
        ...
        {
            return ReadCreatePassiveSpellHistory(packet, indexes);
        }
        ...
        {
            return ReadCreateChrCustomizationChoice(packet, indexes);
        }
        ...
        public static IQuestLog ReadCreateQuestLog(Packet packet, params object[] indexes)
        {
            ...
            data.EnabledObjectivesMask = packet.ReadUInt32("EnabledObjectivesMask", indexes);
            return data;
        }
        ...
        public static ILeaverInfo ReadCreateLeaverInfo(Packet packet, params object[] indexes)
        {
            ...
            packet.ResetBitReader();
            data.IsLeaver = packet.ReadBit("IsLeaver", indexes);
            return data;
        }

        public static ILeaverInfo ReadUpdateLeaverInfo(Packet packet, params object[] indexes)
        {
            return ReadCreateLeaverInfo(packet, indexes);
        }
        ...
        {
            return ReadCreatePlayerDataElement(packet, indexes);
        }
        ...
        public static IPVPInfo ReadCreatePVPInfo(Packet packet, params object[] indexes)
        {
            ...
            data.LastWeeksBestRating = packet.ReadUInt32("LastWeeksBestRating", indexes);
            ...
            data.SeasonBestTier = packet.ReadUInt32("SeasonBestTier", indexes);
        ...
        {
            return ReadCreateResearch(packet, indexes);
        }
        ...
        {
            return ReadCreateCharacterRestriction(packet, indexes);
        }
        ...
        {
            return ReadCreateSpellPctModByLabel(packet, indexes);
        }
        ...
        {
            return ReadCreateSpellFlatModByLabel(packet, indexes);
        }
        ...
        {
            return ReadCreateTraitEntry(packet, indexes);
        }
        ...
        {
            return ReadCreateTraitSubTreeCache(packet, indexes);
        }
        ...
        {
            return ReadCreateCategoryCooldownMod(packet, indexes);
        }
        ...
        {
            return ReadCreateWeeklySpellUse(packet, indexes);
        }
        ...
        {
            return ReadCreateGameObjectAssistActionData(packet, indexes);
        }
        ...
        public override IGameObjectData ReadUpdateGameObjectData(Packet packet, params object[] indexes)
        {
            ...
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            rawChangesMask[0] = (int)packet.ReadBits(27);
            var changesMask = new BitArray(rawChangesMask);
        ...
        public static IVisualAnim ReadCreateVisualAnim(Packet packet, params object[] indexes)
        {
            ...
            data.ServerTime = packet.ReadUInt32("ServerTime", indexes);
        ...
        {
            return ReadCreateForceSetAreaTriggerPositionAndRotation(packet, indexes);
        }
        ...
        public override IAreaTriggerData ReadUpdateAreaTriggerData(Packet packet, params object[] indexes)
        {
            ...
            rawChangesMask[1] = (int)packet.ReadBits(7);
            var changesMask = new BitArray(rawChangesMask);
        ...
        {
            return ReadCreateConversationLine(packet, indexes);
        }
        ...
        {
            return ReadCreateConversationActor(packet, indexes);
        }
        ...
        public override IMeshObjectData ReadCreateMeshObjectData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new MeshObjectData();
            packet.ResetBitReader();
            var hasGeobox = false;
            packet.ResetBitReader();
            data.IsWMO = packet.ReadBit("IsWMO", indexes);
            data.IsRoom = packet.ReadBit("IsRoom", indexes);
            hasGeobox = packet.ReadBit("HasGeobox", indexes);
            data.FileDataID = packet.ReadInt32("FileDataID", indexes);
            if (hasGeobox)
            {
                data.Geobox = new AaBox(packet.ReadVector3("Low", indexes, "Geobox"), packet.ReadVector3("High", indexes, "Geobox"));
            }
            return data;
        }

        public override IMeshObjectData ReadUpdateMeshObjectData(Packet packet, params object[] indexes)
        {
            var data = new MeshObjectData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static IDecorDyeSlots ReadCreateDecorDyeSlots(Packet packet, params object[] indexes)
        {
            var data = new DecorDyeSlots();
            packet.ResetBitReader();
            for (var i = 0; i < 3; ++i)
            {
                data.DyeColorID[i] = packet.ReadInt32("DyeColorID", indexes, i);
            }
            return data;
        }

        public static IDecorDyeSlots ReadUpdateDecorDyeSlots(Packet packet, params object[] indexes)
        {
            return ReadCreateDecorDyeSlots(packet, indexes);
        }

        public static IDecorStoragePersistedData ReadCreateDecorStoragePersistedData(Packet packet, params object[] indexes)
        {
            var data = new DecorStoragePersistedData();
            packet.ResetBitReader();
            var hasDyeSlots = false;
            data.HouseGUID = packet.ReadPackedGuid128("HouseGUID", indexes);
            data.PlacementStatus = packet.ReadByte("PlacementStatus", indexes);
        ...
        public static IDecorStoragePersistedData ReadUpdateDecorStoragePersistedData(Packet packet, params object[] indexes)
        {
            var data = new DecorStoragePersistedData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static IDecorPetInfo ReadCreateDecorPetInfo(Packet packet, params object[] indexes)
        {
            var data = new DecorPetInfo();
            packet.ResetBitReader();
            data.BattlePetGUID = packet.ReadPackedGuid128("BattlePetGUID", indexes);
            data.SpawnGroup = packet.ReadPackedGuid128("SpawnGroup", indexes);
            data.SpawnedPet = packet.ReadPackedGuid128("SpawnedPet", indexes);
            data.CreatureID = packet.ReadUInt32("CreatureID", indexes);
            data.PetBehavior = packet.ReadByte("PetBehavior", indexes);
            packet.ResetBitReader();
            data.PetName = new string('*', (int)packet.ReadBits(6));
            data.PetName = packet.ReadWoWString("PetName", data.PetName.Length, indexes);
            return data;
        }

        public static IDecorPetInfo ReadUpdateDecorPetInfo(Packet packet, params object[] indexes)
        {
            var data = new DecorPetInfo();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public override IHousingDecorData ReadCreateHousingDecorData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingDecorData();
            packet.ResetBitReader();
            var hasPersistedData = false;
            var hasPetInfo = false;
            ...
            hasPetInfo = packet.ReadBit("HasPetInfo", indexes);
            if (hasPersistedData)
            {
                data.PersistedData = ReadCreateDecorStoragePersistedData(packet, indexes, "PersistedData");
            }
            if (hasPetInfo)
            {
                data.PetInfo = ReadCreateDecorPetInfo(packet, indexes, "PetInfo");
            }
            return data;
        }

        public override IHousingDecorData ReadUpdateHousingDecorData(Packet packet, params object[] indexes)
        {
            var data = new HousingDecorData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                ...
                if (changesMask[4])
                {
                    if (hasPersistedData)
                    {
                        data.PersistedData = ReadUpdateDecorStoragePersistedData(packet, indexes, "PersistedData");
                    }
                }
                if (changesMask[5])
                {
                    if (hasPetInfo)
                    {
                        data.PetInfo = ReadUpdateDecorPetInfo(packet, indexes, "PetInfo");
                    }
                }
            }
            return data;
        ...
        public static IHousingDoorData ReadCreateHousingDoorData(Packet packet, params object[] indexes)
        {
            var data = new HousingDoorData();
            packet.ResetBitReader();
            data.RoomComponentID = packet.ReadInt32("RoomComponentID", indexes);
            data.RoomComponentOffset = packet.ReadVector3("RoomComponentOffset", indexes);
            data.RoomComponentType = packet.ReadByte("RoomComponentType", indexes);
            data.AttachedRoomGUID = packet.ReadPackedGuid128("AttachedRoomGUID", indexes);
            return data;
        }

        public static IHousingDoorData ReadUpdateHousingDoorData(Packet packet, params object[] indexes)
        {
            var data = new HousingDoorData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public override IHousingRoomData ReadCreateHousingRoomData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingRoomData();
            packet.ResetBitReader();
            data.HouseGUID = packet.ReadPackedGuid128("HouseGUID", indexes);
            data.HouseRoomID = packet.ReadInt32("HouseRoomID", indexes);
            data.Flags = packet.ReadInt32("Flags", indexes);
            data.MeshObjects.Resize(packet.ReadUInt32());
            data.Doors.Resize(packet.ReadUInt32());
            for (var i = 0; i < data.MeshObjects.Count; ++i)
            {
                data.MeshObjects[i] = packet.ReadPackedGuid128("MeshObjects", indexes, i);
            }
            for (var i = 0; i < data.Doors.Count; ++i)
            {
                data.Doors[i] = ReadCreateHousingDoorData(packet, indexes, "Doors", i);
            }
            return data;
        }

        public override IHousingRoomData ReadUpdateHousingRoomData(Packet packet, params object[] indexes)
        {
            var data = new HousingRoomData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.MeshObjects.ReadUpdateMask(packet);
                }
                if (changesMask[2])
                {
                    data.Doors.ReadUpdateMask(packet);
                }
            }
            packet.ResetBitReader();
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    for (var i = 0; i < data.MeshObjects.Count; ++i)
                    {
                        if (data.MeshObjects.UpdateMask[i])
                        {
                            data.MeshObjects[i] = packet.ReadPackedGuid128("MeshObjects", indexes, i);
                        }
                    }
                ...
                if (changesMask[2])
                {
                    for (var i = 0; i < data.Doors.Count; ++i)
                    {
                        if (data.Doors.UpdateMask[i])
                        {
                            data.Doors[i] = ReadUpdateHousingDoorData(packet, indexes, "Doors", i);
                        }
                    }
                }
                if (changesMask[3])
        ...
        public override IHousingRoomComponentMeshData ReadCreateHousingRoomComponentMeshData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingRoomComponentMeshData();
            packet.ResetBitReader();
            data.RoomGUID = packet.ReadPackedGuid128("RoomGUID", indexes);
            data.RoomComponentOptionID = packet.ReadInt32("RoomComponentOptionID", indexes);
            data.RoomComponentID = packet.ReadInt32("RoomComponentID", indexes);
            data.Field_20 = packet.ReadByte("Field_20", indexes);
            data.RoomComponentType = packet.ReadByte("RoomComponentType", indexes);
            data.Field_24 = packet.ReadInt32("Field_24", indexes);
            data.HouseThemeID = packet.ReadInt32("HouseThemeID", indexes);
            data.RoomComponentTextureID = packet.ReadInt32("RoomComponentTextureID", indexes);
            data.RoomComponentTypeParam = packet.ReadInt32("RoomComponentTypeParam", indexes);
            return data;
        }

        public override IHousingRoomComponentMeshData ReadUpdateHousingRoomComponentMeshData(Packet packet, params object[] indexes)
        {
            var data = new HousingRoomComponentMeshData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public override IHousingPlayerHouseData ReadCreateHousingPlayerHouseData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
        ...
        public override IHousingPlayerHouseData ReadUpdateHousingPlayerHouseData(Packet packet, params object[] indexes)
        {
            var data = new HousingPlayerHouseData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public override IHousingCornerstoneData ReadCreateHousingCornerstoneData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingCornerstoneData();
            packet.ResetBitReader();
            data.Cost = packet.ReadUInt64("Cost", indexes);
            data.PlotIndex = packet.ReadInt32("PlotIndex", indexes);
            return data;
        }

        public override IHousingCornerstoneData ReadUpdateHousingCornerstoneData(Packet packet, params object[] indexes)
        {
            var data = new HousingCornerstoneData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static IPlayerHouseInfo ReadCreatePlayerHouseInfo(Packet packet, params object[] indexes)
        {
            var data = new PlayerHouseInfo();
            packet.ResetBitReader();
            data.HouseGUID = packet.ReadPackedGuid128("HouseGUID", indexes);
            data.OwnerGUID = packet.ReadPackedGuid128("OwnerGUID", indexes);
            return data;
        ...
        public static IPlayerHouseInfo ReadUpdatePlayerHouseInfo(Packet packet, params object[] indexes)
        {
            return ReadCreatePlayerHouseInfo(packet, indexes);
        }

        public static IHousingOwner ReadCreateHousingOwner(Packet packet, params object[] indexes)
        {
            var data = new HousingOwner();
            packet.ResetBitReader();
            data.BnetAccountGUID = packet.ReadPackedGuid128("BnetAccountGUID", indexes);
            data.PlayerGUID = packet.ReadPackedGuid128("PlayerGUID", indexes);
            return data;
        }

        public static IHousingOwner ReadUpdateHousingOwner(Packet packet, params object[] indexes)
        {
            return ReadCreateHousingOwner(packet, indexes);
        }

        public override INeighborhoodMirrorData ReadCreateNeighborhoodMirrorData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new NeighborhoodMirrorData();
            packet.ResetBitReader();
            data.Name = new string('*', (int)packet.ReadBits(8));
            data.OwnerGUID = packet.ReadPackedGuid128("OwnerGUID", indexes);
            ...
            for (var i = 0; i < data.Managers.Count; ++i)
            {
                data.Managers[i] = ReadCreateHousingOwner(packet, indexes, "Managers", i);
            }
            return data;
        }

        public override INeighborhoodMirrorData ReadUpdateNeighborhoodMirrorData(Packet packet, params object[] indexes)
        {
            var data = new NeighborhoodMirrorData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.Houses.ReadUpdateMask(packet);
                }
                if (changesMask[2])
                {
                    data.Managers.ReadUpdateMask(packet);
                }
            }
            packet.ResetBitReader();
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    for (var i = 0; i < data.Houses.Count; ++i)
                    {
                        if (data.Houses.UpdateMask[i])
                        {
                            data.Houses[i] = ReadUpdatePlayerHouseInfo(packet, indexes, "Houses", i);
                        }
                    }
                }
                if (changesMask[2])
                {
                    for (var i = 0; i < data.Managers.Count; ++i)
                    {
                        if (data.Managers.UpdateMask[i])
                        {
                            data.Managers[i] = ReadUpdateHousingOwner(packet, indexes, "Managers", i);
                        }
                    }
                }
            }
        ...
        public static IMirroredMeshObjectData ReadCreateMirroredMeshObjectData(Packet packet, params object[] indexes)
        {
            var data = new MirroredMeshObjectData();
            packet.ResetBitReader();
            data.AttachParentGUID = packet.ReadPackedGuid128("AttachParentGUID", indexes);
            data.PositionLocalSpace = packet.ReadVector3("PositionLocalSpace", indexes);
            data.RotationLocalSpace = packet.ReadQuaternion("RotationLocalSpace", indexes);
            data.ScaleLocalSpace = packet.ReadSingle("ScaleLocalSpace", indexes);
            data.AttachmentFlags = packet.ReadByte("AttachmentFlags", indexes);
            return data;
        }

        public static IMirroredMeshObjectData ReadUpdateMirroredMeshObjectData(Packet packet, params object[] indexes)
        {
            var data = new MirroredMeshObjectData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public override IMirroredPositionData ReadCreateMirroredPositionData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new MirroredPositionData();
            packet.ResetBitReader();
            data.PositionData = ReadCreateMirroredMeshObjectData(packet, indexes, "PositionData");
            return data;
        }

        public override IMirroredPositionData ReadUpdateMirroredPositionData(Packet packet, params object[] indexes)
        {
            var data = new MirroredPositionData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.PositionData = ReadUpdateMirroredMeshObjectData(packet, indexes, "PositionData");
                }
            }
            return data;
        }

        public static IPlayerMirrorHouse ReadCreatePlayerMirrorHouse(Packet packet, params object[] indexes)
        {
        ...
        public static IPlayerMirrorHouse ReadUpdatePlayerMirrorHouse(Packet packet, params object[] indexes)
        {
            return ReadCreatePlayerMirrorHouse(packet, indexes);
        }

        public static INeighborhoodCharterSignature ReadCreateNeighborhoodCharterSignature(Packet packet, params object[] indexes)
        {
            var data = new NeighborhoodCharterSignature();
            packet.ResetBitReader();
            data.Guid = packet.ReadPackedGuid128("Guid", indexes);
            return data;
        }

        public static INeighborhoodCharterSignature ReadUpdateNeighborhoodCharterSignature(Packet packet, params object[] indexes)
        {
            return ReadCreateNeighborhoodCharterSignature(packet, indexes);
        }

        public static INeighborhoodCharter ReadCreateNeighborhoodCharter(Packet packet, params object[] indexes)
        {
            var data = new NeighborhoodCharter();
            packet.ResetBitReader();
            data.Field_0 = packet.ReadInt32("Field_0", indexes);
            data.Field_4 = packet.ReadInt32("Field_4", indexes);
            data.Signatures = new INeighborhoodCharterSignature[packet.ReadUInt32()];
        ...
        public static INeighborhoodCharter ReadUpdateNeighborhoodCharter(Packet packet, params object[] indexes)
        {
            return ReadCreateNeighborhoodCharter(packet, indexes);
        }

        public static INeighborhoodOwnershipTransfer ReadCreateNeighborhoodOwnershipTransfer(Packet packet, params object[] indexes)
        {
            var data = new NeighborhoodOwnershipTransfer();
            packet.ResetBitReader();
            data.NeighborhoodGUID = packet.ReadPackedGuid128("NeighborhoodGUID", indexes);
            data.CurrentOwnerGUID = packet.ReadPackedGuid128("CurrentOwnerGUID", indexes);
            data.NeighborhoodName = new string('*', (int)packet.ReadBits(8));
            packet.ResetBitReader();
            data.NeighborhoodName = packet.ReadDynamicString("NeighborhoodName", data.NeighborhoodName.Length, indexes);
            return data;
        }

        public static INeighborhoodOwnershipTransfer ReadUpdateNeighborhoodOwnershipTransfer(Packet packet, params object[] indexes)
        {
            return ReadCreateNeighborhoodOwnershipTransfer(packet, indexes);
        }

        public override IPlayerHouseInfoComponentData ReadCreatePlayerHouseInfoComponentData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new PlayerHouseInfoComponentData();
            packet.ResetBitReader();
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
                data.Field_8.Resize(packet.ReadUInt32());
            }
            data.Houses.Resize(packet.ReadUInt32());
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
                data.Field_88.Resize(packet.ReadUInt32());
                data.Field_C0.Resize(packet.ReadUInt32());
                data.Field_F8.Resize(packet.ReadUInt32());
                data.Field_130.Resize(packet.ReadUInt32());
                data.Charter = ReadCreateNeighborhoodCharter(packet, indexes, "Charter");
                data.EditorMode = packet.ReadByte("EditorMode", indexes);
                data.NeighborhoodOwnershipTransfer = ReadCreateNeighborhoodOwnershipTransfer(packet, indexes, "NeighborhoodOwnershipTransfer");
                data.CurrentHouse = packet.ReadPackedGuid128("CurrentHouse", indexes);
                for (var i = 0; i < data.Field_8.Count; ++i)
                {
                    data.Field_8[i] = packet.ReadPackedGuid128("Field_8", indexes, i);
                }
            }
            for (var i = 0; i < data.Houses.Count; ++i)
            {
                data.Houses[i] = ReadCreatePlayerMirrorHouse(packet, indexes, "Houses", i);
            }
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
                for (var i = 0; i < data.Field_88.Count; ++i)
                {
                    data.Field_88[i] = packet.ReadPackedGuid128("Field_88", indexes, i);
                }
                for (var i = 0; i < data.Field_C0.Count; ++i)
                {
                    data.Field_C0[i] = packet.ReadPackedGuid128("Field_C0", indexes, i);
                }
                for (var i = 0; i < data.Field_F8.Count; ++i)
                {
                    data.Field_F8[i] = packet.ReadPackedGuid128("Field_F8", indexes, i);
                }
                for (var i = 0; i < data.Field_130.Count; ++i)
                {
                    data.Field_130[i] = packet.ReadPackedGuid128("Field_130", indexes, i);
                }
            }
            return data;
        }

        public override IPlayerHouseInfoComponentData ReadUpdatePlayerHouseInfoComponentData(Packet packet, params object[] indexes)
        {
            var data = new PlayerHouseInfoComponentData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.Field_8.ReadUpdateMask(packet);
                }
                if (changesMask[2])
                {
                    data.Houses.ReadUpdateMask(packet);
                ...
                if (changesMask[3])
                {
                    data.Field_88.ReadUpdateMask(packet);
                }
                if (changesMask[4])
                {
                    data.Field_C0.ReadUpdateMask(packet);
                }
                if (changesMask[5])
                {
                    data.Field_F8.ReadUpdateMask(packet);
                }
                if (changesMask[6])
                {
                    data.Field_130.ReadUpdateMask(packet);
                }
            }
            packet.ResetBitReader();
            if (changesMask[0])
            {
                ...
                if (changesMask[2])
                {
                    for (var i = 0; i < data.Houses.Count; ++i)
                    {
                        if (data.Houses.UpdateMask[i])
                        {
                            data.Houses[i] = ReadUpdatePlayerMirrorHouse(packet, indexes, "Houses", i);
                        }
                    }
                }
                if (changesMask[3])
                ...
                if (changesMask[6])
                {
                    for (var i = 0; i < data.Field_130.Count; ++i)
                    {
                        if (data.Field_130.UpdateMask[i])
                        {
                            data.Field_130[i] = packet.ReadPackedGuid128("Field_130", indexes, i);
                        }
                    }
        ...
        public override IHousingStorageData ReadCreateHousingStorageData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingStorageData();
            packet.ResetBitReader();
            var mapSizeDecor = packet.ReadUInt32();
            for (var m = 0u; m < mapSizeDecor; ++m)
            {
                var key = packet.ReadPackedGuid128("Key", indexes, "Decor", m);
                data.Decor[key] = ReadCreateDecorStoragePersistedData(packet, indexes, "Decor", m, "Value");
            }
            data.DecorMaxOwnedCount = packet.ReadUInt32("DecorMaxOwnedCount", indexes);
            return data;
        }

        public override IHousingStorageData ReadUpdateHousingStorageData(Packet packet, params object[] indexes)
        {
            var data = new HousingStorageData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    var updateTypeDecor = packet.ReadByte();
                    if (updateTypeDecor != 0)
                    {
                        var mapSizeDecor = packet.ReadUInt32();
                        for (var m = 0u; m < mapSizeDecor; ++m)
                        {
                    ...
                    {
                        var changesCountDecor = packet.ReadUInt16();
                        for (var m = 0u; m < changesCountDecor; ++m)
                        {
                            var key = packet.ReadPackedGuid128("Key", indexes, "Decor", m);
                            var changeType = packet.ReadByte("ChangeType", indexes, "Decor", m);
                            if (changeType == 2)
                                continue;
                            data.Decor[key] = ReadUpdateDecorStoragePersistedData(packet, indexes, "Decor", m, "Value");
                        }
                    }
                }
                if (changesMask[2])
        ...
        public override IHousingFixtureData ReadCreateHousingFixtureData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new HousingFixtureData();
            packet.ResetBitReader();
            data.ExteriorComponentID = packet.ReadInt32("ExteriorComponentID", indexes);
            data.HouseExteriorWmoDataID = packet.ReadInt32("HouseExteriorWmoDataID", indexes);
            data.ExteriorComponentHookID = packet.ReadInt32("ExteriorComponentHookID", indexes);
            data.HouseGUID = packet.ReadPackedGuid128("HouseGUID", indexes);
            data.AttachParentGUID = packet.ReadPackedGuid128("AttachParentGUID", indexes);
            data.Guid = packet.ReadPackedGuid128("Guid", indexes);
            data.GameObjectGUID = packet.ReadPackedGuid128("GameObjectGUID", indexes);
            data.ExteriorComponentType = packet.ReadByte("ExteriorComponentType", indexes);
            data.Field_59 = packet.ReadByte("Field_59", indexes);
            data.Size = packet.ReadByte("Size", indexes);
            return data;
        }

        public override IHousingFixtureData ReadUpdateHousingFixtureData(Packet packet, params object[] indexes)
        {
            var data = new HousingFixtureData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static IPlayerInitiativeInfo ReadCreatePlayerInitiativeInfo(Packet packet, params object[] indexes)
        {
            var data = new PlayerInitiativeInfo();
            packet.ResetBitReader();
            data.RemainingDuration = packet.ReadInt64("RemainingDuration", indexes);
            data.CurrentInitiativeID = packet.ReadInt32("CurrentInitiativeID", indexes);
            data.CurrentMilestoneID = packet.ReadInt32("CurrentMilestoneID", indexes);
            data.CurrentCycleID = packet.ReadInt32("CurrentCycleID", indexes);
            data.ProgressRequired = packet.ReadSingle("ProgressRequired", indexes);
            data.CurrentProgress = packet.ReadSingle("CurrentProgress", indexes);
            data.PlayerTotalContribution = packet.ReadSingle("PlayerTotalContribution", indexes);
            return data;
        }

        public static IPlayerInitiativeInfo ReadUpdatePlayerInitiativeInfo(Packet packet, params object[] indexes)
        {
            var data = new PlayerInitiativeInfo();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static IPlayerInitiativeTaskInfo ReadCreatePlayerInitiativeTaskInfo(Packet packet, params object[] indexes)
        {
            var data = new PlayerInitiativeTaskInfo();
            packet.ResetBitReader();
            data.TaskID = packet.ReadInt32("TaskID", indexes);
            data.TimesCompleted = packet.ReadInt32("TimesCompleted", indexes);
            return data;
        }

        public static IPlayerInitiativeTaskInfo ReadUpdatePlayerInitiativeTaskInfo(Packet packet, params object[] indexes)
        {
            var data = new PlayerInitiativeTaskInfo();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
        ...
        public static INICompletedMilestoneEntry ReadCreateNICompletedMilestoneEntry(Packet packet, params object[] indexes)
        {
            var data = new NICompletedMilestoneEntry();
            packet.ResetBitReader();
            data.AwardDate = packet.ReadInt64("AwardDate", indexes);
            data.MilestoneID = packet.ReadUInt32("MilestoneID", indexes);
            return data;
        }

        public static INICompletedMilestoneEntry ReadUpdateNICompletedMilestoneEntry(Packet packet, params object[] indexes)
        {
            return ReadCreateNICompletedMilestoneEntry(packet, indexes);
        }

        public static INICompletedInitiativesEntry ReadCreateNICompletedInitiativesEntry(Packet packet, params object[] indexes)
        {
            var data = new NICompletedInitiativesEntry();
            packet.ResetBitReader();
            data.InitiativeID = packet.ReadUInt32("InitiativeID", indexes);
            data.CompletedMilestones = new INICompletedMilestoneEntry[packet.ReadUInt32()];
            for (var i = 0; i < data.CompletedMilestones.Length; ++i)
            {
                data.CompletedMilestones[i] = ReadCreateNICompletedMilestoneEntry(packet, indexes, "CompletedMilestones", i);
            }
            packet.ResetBitReader();
            data.Completed = packet.ReadBit("Completed", indexes);
            return data;
        }

        public static INICompletedInitiativesEntry ReadUpdateNICompletedInitiativesEntry(Packet packet, params object[] indexes)
        {
            return ReadCreateNICompletedInitiativesEntry(packet, indexes);
        }

        public override IPlayerInitiativeComponentData ReadCreatePlayerInitiativeComponentData(Packet packet, UpdateFieldFlag flags, params object[] indexes)
        {
            var data = new PlayerInitiativeComponentData();
            packet.ResetBitReader();
            data.NeighborhoodGUID = packet.ReadPackedGuid128("NeighborhoodGUID", indexes);
            data.InitiativeInfo = ReadCreatePlayerInitiativeInfo(packet, indexes, "InitiativeInfo");
            data.CompletedTasks.Resize(packet.ReadUInt32());
            data.CompletedInitiatives.Resize(packet.ReadUInt32());
            if ((flags & UpdateFieldFlag.Owner) != UpdateFieldFlag.None)
            {
                var setSizeHouses = packet.ReadUInt32();
                for (var s = 0u; s < setSizeHouses; ++s)
                {
                    var val = packet.ReadPackedGuid128("Value", indexes, "Houses", s);
                    data.Houses.Add(val);
                }
            }
            for (var i = 0; i < data.CompletedTasks.Count; ++i)
            {
                data.CompletedTasks[i] = ReadCreatePlayerInitiativeTaskInfo(packet, indexes, "CompletedTasks", i);
            }
            for (var i = 0; i < data.CompletedInitiatives.Count; ++i)
            {
                data.CompletedInitiatives[i] = ReadCreateNICompletedInitiativesEntry(packet, indexes, "CompletedInitiatives", i);
            }
            return data;
        }

        public override IPlayerInitiativeComponentData ReadUpdatePlayerInitiativeComponentData(Packet packet, params object[] indexes)
        {
            var data = new PlayerInitiativeComponentData();
            packet.ResetBitReader();
            var rawChangesMask = new int[1];
            ...
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    data.CompletedTasks.ReadUpdateMask(packet);
                }
                if (changesMask[2])
                {
                    data.CompletedInitiatives.ReadUpdateMask(packet);
                }
            }
            packet.ResetBitReader();
            if (changesMask[0])
            {
                if (changesMask[1])
                {
                    for (var i = 0; i < data.CompletedTasks.Count; ++i)
                    {
                        if (data.CompletedTasks.UpdateMask[i])
                        {
                            data.CompletedTasks[i] = ReadUpdatePlayerInitiativeTaskInfo(packet, indexes, "CompletedTasks", i);
                        }
                    }
                }
                if (changesMask[2])
                {
                    for (var i = 0; i < data.CompletedInitiatives.Count; ++i)
                    {
                        if (data.CompletedInitiatives.UpdateMask[i])
                        {
                            data.CompletedInitiatives[i] = ReadUpdateNICompletedInitiativesEntry(packet, indexes, "CompletedInitiatives", i);
                        }
                    }
                }
                if (changesMask[3])
                ...
                if (changesMask[4])
                {
                    data.InitiativeInfo = ReadUpdatePlayerInitiativeInfo(packet, indexes, "InitiativeInfo");
                }
                if (changesMask[5])
                {
                    var updateTypeHouses = packet.ReadByte();
                    if (updateTypeHouses != 0)
                    {
                        var setSizeHouses = packet.ReadUInt32();
                        for (var s = 0u; s < setSizeHouses; ++s)
                        {
                    ...
                    {
                        var changesCountHouses = packet.ReadUInt16();
                        for (var s = 0u; s < changesCountHouses; ++s)
                        {
                            var value = packet.ReadPackedGuid128("Value", indexes, "Houses", s);
                            var changeType = packet.ReadByte("ChangeType", indexes, "Houses", s);
                            if (changeType == 2)
                                continue;
                            data.Houses.Add(value);
                        }
                    }
                }
            }
