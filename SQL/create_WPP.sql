...
CREATE TABLE IF NOT EXISTS `WPP`.`SniffData` (
  ...
  `ObjectType` ENUM('None','Spell','Map','LFGDungeon','Battleground','Unit','GameObject','Item','Quest','Opcode','PageText','NpcText','Gossip','Zone','Area') NOT NULL DEFAULT 'None', -- StoreNameType.cs enum
