namespace WowPacketParserModule.V6_2_2_20444.Enums
{
    ...
    public enum PlayerField
    {
        ...
        PLAYER__FIELD_KNOWN_TITLES                             = UnitField.UNIT_END + 0x618, // Size: 12, Flags: PRIVATE
        PLAYER_FIELD_COINAGE                                   = UnitField.UNIT_END + 0x624, // Size: 2, Flags: PRIVATE
        PLAYER_XP                                              = UnitField.UNIT_END + 0x626, // Size: 1, Flags: PRIVATE
        PLAYER_NEXT_LEVEL_XP                                   = UnitField.UNIT_END + 0x627, // Size: 1, Flags: PRIVATE
        PLAYER_SKILL_LINEID                                    = UnitField.UNIT_END + 0x628, // Size: 448, Flags: PRIVATE
        PLAYER_CHARACTER_POINTS                                = UnitField.UNIT_END + 0x7E8, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MAX_TALENT_TIERS                          = UnitField.UNIT_END + 0x7E9, // Size: 1, Flags: PRIVATE
        PLAYER_TRACK_CREATURES                                 = UnitField.UNIT_END + 0x7EA, // Size: 1, Flags: PRIVATE
        PLAYER_TRACK_RESOURCES                                 = UnitField.UNIT_END + 0x7EB, // Size: 1, Flags: PRIVATE
        PLAYER_EXPERTISE                                       = UnitField.UNIT_END + 0x7EC, // Size: 1, Flags: PRIVATE
        PLAYER_OFFHAND_EXPERTISE                               = UnitField.UNIT_END + 0x7ED, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_RANGED_EXPERTISE                          = UnitField.UNIT_END + 0x7EE, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_COMBAT_RATING_EXPERTISE                   = UnitField.UNIT_END + 0x7EF, // Size: 1, Flags: PRIVATE
        PLAYER_BLOCK_PERCENTAGE                                = UnitField.UNIT_END + 0x7F0, // Size: 1, Flags: PRIVATE
        PLAYER_DODGE_PERCENTAGE                                = UnitField.UNIT_END + 0x7F1, // Size: 1, Flags: PRIVATE
        PLAYER_PARRY_PERCENTAGE                                = UnitField.UNIT_END + 0x7F2, // Size: 1, Flags: PRIVATE
        PLAYER_CRIT_PERCENTAGE                                 = UnitField.UNIT_END + 0x7F3, // Size: 1, Flags: PRIVATE
        PLAYER_RANGED_CRIT_PERCENTAGE                          = UnitField.UNIT_END + 0x7F4, // Size: 1, Flags: PRIVATE
        PLAYER_OFFHAND_CRIT_PERCENTAGE                         = UnitField.UNIT_END + 0x7F5, // Size: 1, Flags: PRIVATE
        PLAYER_SPELL_CRIT_PERCENTAGE1                          = UnitField.UNIT_END + 0x7F6, // Size: 7, Flags: PRIVATE
        PLAYER_SHIELD_BLOCK                                    = UnitField.UNIT_END + 0x7FD, // Size: 1, Flags: PRIVATE
        PLAYER_SHIELD_BLOCK_CRIT_PERCENTAGE                    = UnitField.UNIT_END + 0x7FE, // Size: 1, Flags: PRIVATE
        PLAYER_MASTERY                                         = UnitField.UNIT_END + 0x7FF, // Size: 1, Flags: PRIVATE
        PLAYER_AMPLIFY                                         = UnitField.UNIT_END + 0x800, // Size: 1, Flags: PRIVATE
        PLAYER_MULTISTRIKE                                     = UnitField.UNIT_END + 0x801, // Size: 1, Flags: PRIVATE
        PLAYER_MULTISTRIKE_EFFECT                              = UnitField.UNIT_END + 0x802, // Size: 1, Flags: PRIVATE
        PLAYER_READINESS                                       = UnitField.UNIT_END + 0x803, // Size: 1, Flags: PRIVATE
        PLAYER_SPEED                                           = UnitField.UNIT_END + 0x804, // Size: 1, Flags: PRIVATE
        PLAYER_LIFESTEAL                                       = UnitField.UNIT_END + 0x805, // Size: 1, Flags: PRIVATE
        PLAYER_AVOIDANCE                                       = UnitField.UNIT_END + 0x806, // Size: 1, Flags: PRIVATE
        PLAYER_STURDINESS                                      = UnitField.UNIT_END + 0x807, // Size: 1, Flags: PRIVATE
        PLAYER_CLEAVE                                          = UnitField.UNIT_END + 0x808, // Size: 1, Flags: PRIVATE
        PLAYER_VERSATILITY                                     = UnitField.UNIT_END + 0x809, // Size: 1, Flags: PRIVATE
        PLAYER_VERSATILITY_BONUS                               = UnitField.UNIT_END + 0x80A, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_PVP_POWER_DAMAGE                          = UnitField.UNIT_END + 0x80B, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_PVP_POWER_HEALING                         = UnitField.UNIT_END + 0x80C, // Size: 1, Flags: PRIVATE
        PLAYER_EXPLORED_ZONES_1                                = UnitField.UNIT_END + 0x80D, // Size: 256, Flags: PRIVATE
        PLAYER_REST_STATE_EXPERIENCE                           = UnitField.UNIT_END + 0x90D, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_DAMAGE_DONE_POS                       = UnitField.UNIT_END + 0x90E, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                       = UnitField.UNIT_END + 0x915, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                       = UnitField.UNIT_END + 0x91C, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_MOD_HEALING_DONE_POS                      = UnitField.UNIT_END + 0x923, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_HEALING_PCT                           = UnitField.UNIT_END + 0x924, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_HEALING_DONE_PCT                      = UnitField.UNIT_END + 0x925, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_PERIODIC_HEALING_DONE_PERCENT         = UnitField.UNIT_END + 0x926, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS                    = UnitField.UNIT_END + 0x927, // Size: 3, Flags: PRIVATE
        PLAYER_FIELD_WEAPON_ATK_SPEED_MULTIPLIERS              = UnitField.UNIT_END + 0x92A, // Size: 3, Flags: PRIVATE
        PLAYER_FIELD_MOD_SPELL_POWER_PCT                       = UnitField.UNIT_END + 0x92D, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_RESILIENCE_PERCENT                    = UnitField.UNIT_END + 0x92E, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_OVERRIDE_SPELL_POWER_BY_AP_PCT            = UnitField.UNIT_END + 0x92F, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_OVERRIDE_AP_BY_SPELL_POWER_PERCENT        = UnitField.UNIT_END + 0x930, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_TARGET_RESISTANCE                     = UnitField.UNIT_END + 0x931, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE            = UnitField.UNIT_END + 0x932, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_LOCAL_FLAGS                               = UnitField.UNIT_END + 0x933, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BYTES                                     = UnitField.UNIT_END + 0x934, // Size: 1, Flags: PRIVATE
        PLAYER_SELF_RES_SPELL                                  = UnitField.UNIT_END + 0x935, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_PVP_MEDALS                                = UnitField.UNIT_END + 0x936, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BUYBACK_PRICE_1                           = UnitField.UNIT_END + 0x937, // Size: 12, Flags: PRIVATE
        PLAYER_FIELD_BUYBACK_TIMESTAMP_1                       = UnitField.UNIT_END + 0x943, // Size: 12, Flags: PRIVATE
        PLAYER_FIELD_KILLS                                     = UnitField.UNIT_END + 0x94F, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_LIFETIME_HONORABLE_KILLS                  = UnitField.UNIT_END + 0x950, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_WATCHED_FACTION_INDEX                     = UnitField.UNIT_END + 0x951, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_COMBAT_RATING_1                           = UnitField.UNIT_END + 0x952, // Size: 32, Flags: PRIVATE
        PLAYER_FIELD_ARENA_TEAM_INFO_1_1                       = UnitField.UNIT_END + 0x972, // Size: 36, Flags: PRIVATE
        PLAYER_FIELD_MAX_LEVEL                                 = UnitField.UNIT_END + 0x996, // Size: 1, Flags: PRIVATE
        PLAYER_RUNE_REGEN_1                                    = UnitField.UNIT_END + 0x997, // Size: 4, Flags: PRIVATE
        PLAYER_NO_REAGENT_COST_1                               = UnitField.UNIT_END + 0x99B, // Size: 4, Flags: PRIVATE
        PLAYER_FIELD_GLYPH_SLOTS_1                             = UnitField.UNIT_END + 0x99F, // Size: 6, Flags: PRIVATE
        PLAYER_FIELD_GLYPHS_1                                  = UnitField.UNIT_END + 0x9A5, // Size: 6, Flags: PRIVATE
        PLAYER_GLYPHS_ENABLED                                  = UnitField.UNIT_END + 0x9AB, // Size: 1, Flags: PRIVATE
        PLAYER_PET_SPELL_POWER                                 = UnitField.UNIT_END + 0x9AC, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_RESEARCHING_1                             = UnitField.UNIT_END + 0x9AD, // Size: 10, Flags: PRIVATE
        PLAYER_PROFESSION_SKILL_LINE_1                         = UnitField.UNIT_END + 0x9B7, // Size: 2, Flags: PRIVATE
        PLAYER_FIELD_UI_HIT_MODIFIER                           = UnitField.UNIT_END + 0x9B9, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_UI_SPELL_HIT_MODIFIER                     = UnitField.UNIT_END + 0x9BA, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_HOME_REALM_TIME_OFFSET                    = UnitField.UNIT_END + 0x9BB, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_PET_HASTE                             = UnitField.UNIT_END + 0x9BC, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_SUMMONED_BATTLE_PET_ID                    = UnitField.UNIT_END + 0x9BD, // Size: 4, Flags: PRIVATE
        PLAYER_FIELD_BYTES2                                    = UnitField.UNIT_END + 0x9C1, // Size: 1, Flags: PRIVATE, URGENT_SELF_ONLY
        PLAYER_FIELD_LFG_BONUS_FACTION_ID                      = UnitField.UNIT_END + 0x9C2, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_LOOT_SPEC_ID                              = UnitField.UNIT_END + 0x9C3, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_OVERRIDE_ZONE_PVP_TYPE                    = UnitField.UNIT_END + 0x9C4, // Size: 1, Flags: PRIVATE, URGENT_SELF_ONLY
        PLAYER_FIELD_ITEM_LEVEL_DELTA                          = UnitField.UNIT_END + 0x9C5, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BAG_SLOT_FLAGS                            = UnitField.UNIT_END + 0x9C6, // Size: 4, Flags: PRIVATE
        PLAYER_FIELD_BANK_BAG_SLOT_FLAGS                       = UnitField.UNIT_END + 0x9CA, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_INSERT_ITEMS_LEFT_TO_RIGHT                = UnitField.UNIT_END + 0x9D1, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_QUEST_COMPLETED                           = UnitField.UNIT_END + 0x9D2, // Size: 875, Flags: PRIVATE
        PLAYER_END                                             = UnitField.UNIT_END + 0xD3D,
    }
