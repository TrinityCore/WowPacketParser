namespace WowPacketParserModule.V7_1_5_23360.Enums
{
    ...
    public enum PlayerField
    {
        ...
        PLAYER_FIELD_QUEST_COMPLETED                           = UnitField.UNIT_END + 0xA04, // Size: 1000, Flags: PRIVATE
        PLAYER_FIELD_HONOR                                     = UnitField.UNIT_END + 0xDEC, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_HONOR_NEXT_LEVEL                          = UnitField.UNIT_END + 0xDED, // Size: 1, Flags: PRIVATE
        PLAYER_END                                             = UnitField.UNIT_END + 0xDEE,
    }
    ...
    public enum AreaTriggerField
    {
        ...
        AREATRIGGER_SPELL_X_SPELL_VISUAL_ID                    = ObjectField.OBJECT_END + 0x017, // Size: 1, Flags: PUBLIC
        ...
        AREATRIGGER_CREATING_EFFECT_GUID                       = ObjectField.OBJECT_END + 0x01A, // Size: 4, Flags: PUBLIC
        AREATRIGGER_END                                        = ObjectField.OBJECT_END + 0x01E,
    }
