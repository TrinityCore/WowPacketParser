namespace WowPacketParserModule.V7_3_2_25383.Enums
{
    ...
    public enum PlayerField
    {
        ...
        PLAYER_EXPLORED_ZONES_1                                = UnitField.UNIT_END + 0x849, // Size: 320, Flags: PRIVATE
        PLAYER_FIELD_REST_INFO                                 = UnitField.UNIT_END + 0x989, // Size: 4, Flags: PRIVATE
        PLAYER_FIELD_MOD_DAMAGE_DONE_POS                       = UnitField.UNIT_END + 0x98D, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_MOD_DAMAGE_DONE_NEG                       = UnitField.UNIT_END + 0x994, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_MOD_DAMAGE_DONE_PCT                       = UnitField.UNIT_END + 0x99B, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_MOD_HEALING_DONE_POS                      = UnitField.UNIT_END + 0x9A2, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_HEALING_PCT                           = UnitField.UNIT_END + 0x9A3, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_HEALING_DONE_PCT                      = UnitField.UNIT_END + 0x9A4, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_PERIODIC_HEALING_DONE_PERCENT         = UnitField.UNIT_END + 0x9A5, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_WEAPON_DMG_MULTIPLIERS                    = UnitField.UNIT_END + 0x9A6, // Size: 3, Flags: PRIVATE
        PLAYER_FIELD_WEAPON_ATK_SPEED_MULTIPLIERS              = UnitField.UNIT_END + 0x9A9, // Size: 3, Flags: PRIVATE
        PLAYER_FIELD_MOD_SPELL_POWER_PCT                       = UnitField.UNIT_END + 0x9AC, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_RESILIENCE_PERCENT                    = UnitField.UNIT_END + 0x9AD, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_OVERRIDE_SPELL_POWER_BY_AP_PCT            = UnitField.UNIT_END + 0x9AE, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_OVERRIDE_AP_BY_SPELL_POWER_PERCENT        = UnitField.UNIT_END + 0x9AF, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_TARGET_RESISTANCE                     = UnitField.UNIT_END + 0x9B0, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_TARGET_PHYSICAL_RESISTANCE            = UnitField.UNIT_END + 0x9B1, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_LOCAL_FLAGS                               = UnitField.UNIT_END + 0x9B2, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BYTES                                     = UnitField.UNIT_END + 0x9B3, // Size: 1, Flags: PRIVATE
        PLAYER_SELF_RES_SPELL                                  = UnitField.UNIT_END + 0x9B4, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_PVP_MEDALS                                = UnitField.UNIT_END + 0x9B5, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BUYBACK_PRICE_1                           = UnitField.UNIT_END + 0x9B6, // Size: 12, Flags: PRIVATE
        PLAYER_FIELD_BUYBACK_TIMESTAMP_1                       = UnitField.UNIT_END + 0x9C2, // Size: 12, Flags: PRIVATE
        PLAYER_FIELD_KILLS                                     = UnitField.UNIT_END + 0x9CE, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_LIFETIME_HONORABLE_KILLS                  = UnitField.UNIT_END + 0x9CF, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_WATCHED_FACTION_INDEX                     = UnitField.UNIT_END + 0x9D0, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_COMBAT_RATING_1                           = UnitField.UNIT_END + 0x9D1, // Size: 32, Flags: PRIVATE
        PLAYER_FIELD_ARENA_TEAM_INFO_1_1                       = UnitField.UNIT_END + 0x9F1, // Size: 42, Flags: PRIVATE
        PLAYER_FIELD_MAX_LEVEL                                 = UnitField.UNIT_END + 0xA1B, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_SCALING_PLAYER_LEVEL_DELTA                = UnitField.UNIT_END + 0xA1C, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MAX_CREATURE_SCALING_LEVEL                = UnitField.UNIT_END + 0xA1D, // Size: 1, Flags: PRIVATE
        PLAYER_NO_REAGENT_COST_1                               = UnitField.UNIT_END + 0xA1E, // Size: 4, Flags: PRIVATE
        PLAYER_PET_SPELL_POWER                                 = UnitField.UNIT_END + 0xA22, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_RESEARCHING_1                             = UnitField.UNIT_END + 0xA23, // Size: 10, Flags: PRIVATE
        PLAYER_PROFESSION_SKILL_LINE_1                         = UnitField.UNIT_END + 0xA2D, // Size: 2, Flags: PRIVATE
        PLAYER_FIELD_UI_HIT_MODIFIER                           = UnitField.UNIT_END + 0xA2F, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_UI_SPELL_HIT_MODIFIER                     = UnitField.UNIT_END + 0xA30, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_HOME_REALM_TIME_OFFSET                    = UnitField.UNIT_END + 0xA31, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_MOD_PET_HASTE                             = UnitField.UNIT_END + 0xA32, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BYTES2                                    = UnitField.UNIT_END + 0xA33, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_BYTES3                                    = UnitField.UNIT_END + 0xA34, // Size: 1, Flags: PRIVATE, URGENT_SELF_ONLY
        PLAYER_FIELD_LFG_BONUS_FACTION_ID                      = UnitField.UNIT_END + 0xA35, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_LOOT_SPEC_ID                              = UnitField.UNIT_END + 0xA36, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_OVERRIDE_ZONE_PVP_TYPE                    = UnitField.UNIT_END + 0xA37, // Size: 1, Flags: PRIVATE, URGENT_SELF_ONLY
        PLAYER_FIELD_BAG_SLOT_FLAGS                            = UnitField.UNIT_END + 0xA38, // Size: 4, Flags: PRIVATE
        PLAYER_FIELD_BANK_BAG_SLOT_FLAGS                       = UnitField.UNIT_END + 0xA3C, // Size: 7, Flags: PRIVATE
        PLAYER_FIELD_INSERT_ITEMS_LEFT_TO_RIGHT                = UnitField.UNIT_END + 0xA43, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_QUEST_COMPLETED                           = UnitField.UNIT_END + 0xA44, // Size: 1750, Flags: PRIVATE
        PLAYER_FIELD_HONOR                                     = UnitField.UNIT_END + 0x111A, // Size: 1, Flags: PRIVATE
        PLAYER_FIELD_HONOR_NEXT_LEVEL                          = UnitField.UNIT_END + 0x111B, // Size: 1, Flags: PRIVATE
        PLAYER_END                                             = UnitField.UNIT_END + 0x111C,
    }
